        ...
        <div class="flex flex-col items-center justify-between space-y-3 p-6 md:flex-row md:space-x-4 md:space-y-0">
            ...
            <div class="flex gap-2">
                <a href="{{ route('sales-report.index') }}"
                    class="flex flex-row items-center justify-center rounded-lg bg-[#0D223A] border border-slate-700/50 px-4 py-2 font-semibold text-white hover:bg-slate-700">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-1.5 h-5 w-5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
