            ...
            <div class="flex gap-2">
                <div class="dropdown dropdown-end">
                    ...
                    <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
                        <li><a href="{{ route('dashboard.supervisor.export.performance', ['type' => 'weekly']) }}">Weekly
                                Performance</a></li>
                        <li><a href="{{ route('dashboard.supervisor.export.performance', ['type' => 'monthly']) }}">Monthly
                                Performance</a></li>
                    </ul>
                </div>
        ...
        <div class="grid auto-rows-max grid-cols-8 gap-6 p-6 pt-0">
            ...
            <div class="col-span-8 flex w-full flex-col rounded-2xl shadow-md md:col-span-2">
                <div class="w-full rounded-t-2xl bg-gradient-to-r from-[#225A97] to-[#0D223A]">
                    <h1 class="text-md p-5 font-bold uppercase tracking-wider text-white opacity-90">Menunggu
                        Persetujuan</h1>
                </div>
            ...
            <div class="col-span-8 flex w-full flex-col rounded-2xl shadow-md md:col-span-2">
                <div class="w-full rounded-t-2xl bg-gradient-to-r from-[#225A97] to-[#0D223A]">
                    <h1 class="text-md p-5 font-bold uppercase tracking-wider text-white opacity-90">Pesanan Disetujui
                        (Bulan Ini)</h1>
                </div>
                <div class="flex flex-col justify-center p-6">
                    <div class="flex flex-col items-center">
                        <div class="flex w-full flex-row items-end justify-center">
                            <h1 class="text-4xl font-bold text-gray-900 dark:text-gray-100 lg:text-6xl">
                                {{ $totalApproved }}</h1>
                        </div>
            ...
            <div class="col-span-8 flex w-full flex-col rounded-2xl shadow-md md:col-span-2">
                <div class="w-full rounded-t-2xl bg-gradient-to-r from-[#225A97] to-[#0D223A]">
                    <h1 class="text-md p-5 font-bold uppercase tracking-wider text-white opacity-90">Pendapatan Bulan
                        Ini</h1>
                </div>
                <div class="flex h-full flex-col justify-center p-6">
                    <div class="flex h-full flex-col items-center justify-center">
                        <div class="flex w-full flex-row items-center justify-center">
                            ...
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 lg:text-3xl">
            ...
            <div class="col-span-8 flex w-full flex-col rounded-2xl shadow-md md:col-span-2">
                <div class="w-full rounded-t-2xl bg-gradient-to-r from-[#225A97] to-[#0D223A]">
                    <h1 class="text-md p-5 font-bold uppercase tracking-wider text-white opacity-90">Penjualan Selesai
                    </h1>
                </div>
                <div class="flex flex-col justify-center p-6">
                    <div class="flex flex-col items-center">
            ...
            <div
                ...
                <div
                    ...
                    <h1 class="text-md p-5 font-bold uppercase tracking-wider text-white opacity-90">Profit Sales Per
                        Akun</h1>
                </div>
                ...
                <div
                    ...
                    <select id="imc-year-select"
                        ...
                        @foreach ($imc_years as $y)
                            <option value="{{ $y }}" {{ $y == $selectedYear ? 'selected' : '' }} class="text-black">{{ $y }}
                            </option>
                        @endforeach
                    </select>
                </div>
