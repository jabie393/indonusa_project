            ...
            <div class="inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm col-span-8 flex min-h-0 w-full flex-col rounded-2xl shadow-md md:col-span-4">
                ...
                <div class="min-h-0 flex-1 overflow-hidden">
                    <div class="h-full w-full">
                        <canvas id="IMC" class="block h-full w-full" data-labels='@json($imc_labels)' data-masuk='@json($imc_masuk)' data-keluar='@json($imc_keluar)' data-endpoint='{{ route('dashboard.chart.data') }}'></canvas>
                    </div>
                </div>
            </div>
