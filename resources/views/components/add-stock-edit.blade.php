...
<div id="tambahStockModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative mx-auto max-h-full w-full max-w-3xl">
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between rounded-t border-b p-4 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="tambahStockModal">
                    ...
                    <div class="md:col-span-1">
                        <div class="mb-4">
                            ...
                            <div id="edit_gambar_preview" class="mt-2 flex justify-center">
                                <div
                                    class="h-48 w-48 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 flex items-center justify-center dark:border-gray-600 dark:bg-gray-800">
                ...
                <div
                    ...
                    <form id="tambahStockForm" method="POST" class="space-y-4" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            <div>
                                <label for="edit_stok"
                                    class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Stok
                                    Baru</label>
