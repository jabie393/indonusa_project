<dialog id="editBarangModal" class="modal">
    <div class="modal-box relative flex h-full w-full max-w-5xl flex-col overflow-hidden rounded-lg bg-white p-0 shadow dark:bg-gray-700 sm:max-h-[90vh]">
        ...
        <form id="editBarangForm" method="POST" class="flex h-full flex-col space-y-4 overflow-hidden p-4" enctype="multipart/form-data">
            ...
            <div class="">
                <button type="submit"
                    class="position-relative w-full rounded-lg bg-gradient-to-r from-[#225A97] to-[#0B1D31] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Update
                </button>
            </div>
        </form>
    </div>
