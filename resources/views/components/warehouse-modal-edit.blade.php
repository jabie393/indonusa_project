                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="edit_kategori" name="kategori"
                                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400"
                                        data-initial-kategori="{{ $barang->kategori }}" data-initial-kode="{{ $barang->kode_barang }}">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="relative">
                                        ...
                                        <button type="button" id="editRefreshKodeBarang" class="absolute inset-y-0 right-0 flex items-center pr-3">
                                            <svg class="h-5 w-5 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" viewBox="0 0 24 24" fill="none"
