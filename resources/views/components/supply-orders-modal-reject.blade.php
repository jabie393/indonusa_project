<dialog id="rejectNoteModal" class="modal">
    <form method="POST" id="rejectNoteForm" class="modal-box relative w-full max-w-md rounded-lg bg-white p-6 shadow dark:bg-gray-700">
        ...
        <div class="mb-4">
            ...
            <textarea name="catatan" id="reject_note" rows="3" required class="block w-full rounded-lg border bg-white border-gray-300 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-800 dark:text-white"></textarea>
        </div>
