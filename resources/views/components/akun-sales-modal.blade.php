...
<div id="createSalesAccountModal"
    ...
    <div class="bg-white p-6 rounded shadow-md">
        ...
        <form action="{{ route('akun-sales.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" id="createEmail" name="email" autocomplete="new-email"
                    class="w-full border rounded px-3 py-2">
            </div>
            <div class="mb-4">
                <label for="createPassword" class="block text-sm font-medium">Password</label>
                <input type="password" id="createPassword" name="password" autocomplete="new-password"
                    class="w-full border rounded px-3 py-2">
            </div>
