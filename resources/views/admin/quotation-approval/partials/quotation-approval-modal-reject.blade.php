    {{-- ===================================================
         REJECT MODAL - Single modal used for all rows
         ===================================================  --}}
            ...
            <div class="relative bg-gradient-to-r from-[#225A97] to-[#0D223A] px-6 py-5">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-xs font-medium text-rose-100/80">Number: <span id="modalTolakNomor"></span></p>
                    </div>
                    <form method="dialog">
                ...
                <div class="px-7 py-6">
                    <div class="mb-5 rounded-lg border border-amber-100 bg-amber-50 p-3">
                        <div class="flex space-x-2">
                            ...
                            <p class="text-[11px] font-medium leading-relaxed text-amber-800">Please include a constructive reason so the sales team can revise it properly.</p>
                        </div>
                    </div>
