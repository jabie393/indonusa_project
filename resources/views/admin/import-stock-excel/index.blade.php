<x-app-layout>
    <div class="relative overflow-hidden rounded-2xl bg-white shadow-md dark:bg-gray-800">
        <div class="flex flex-col items-center justify-between space-y-3 bg-gradient-to-r from-[#225A97] to-[#0D223A] p-4 md:flex-row md:space-x-4 md:space-y-0">
            ...
            <div class="p-4">
                <a href="{{ route('import-stock-excel.export') }}"
        ...
        <form action="{{ route('import-stock-excel.import') }}"
              method="POST"
              class="flex h-fit flex-col space-y-4 overflow-auto p-4"
                        ...
                        <div class="mb-4 w-full">
                            ...
                            <div id="upload-area"
                                ...
                                <label id="upload-label"
                                    ...
                                    <div id="excel_filename"
                                         class="hidden"></div>
                                </label>

                                <!-- 2. Progress State -->
                                <div id="progress-section"
                                     class="hidden w-full max-w-md p-6">
                                ...
                                <div id="upload-result"
                                     class="hidden w-full cursor-default p-6">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="relative">
                                        ...
                                        <input class="w-full rounded-lg border border-gray-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm text-gray-900 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                               placeholder="0"
                                               type="text"
                                               required />
                                        <input type="hidden"
