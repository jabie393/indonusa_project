<dialog id="modalTolakGlobal" class="modal">
    <div class="modal-box max-w-md overflow-hidden rounded-2xl bg-white p-0 dark:bg-gray-800">
        {{-- Header --}}
            ...
            <div class="px-7 py-6">
                <div class="mb-5 rounded-lg border border-amber-100 bg-amber-50 p-3">
                    <div class="flex space-x-2">
                        ...
                        <p class="text-[11px] font-medium leading-relaxed text-amber-800" id="tolakNote">Harap sertakan alasan yang konstruktif agar tim dapat melakukan revisi dengan tepat.</p>
                    </div>
                </div>
