                ...
                <table class="sortable hover w-full text-left text-sm text-gray-500 dark:text-gray-400" id="">
                    ...
                    <tbody class="text-nowrap">
                        @foreach ($orders as $order)
                            <tr
                                class="border-b border-gray-100 dark:border-gray-700/50 hover:bg-slate-50/80 dark:hover:bg-gray-700/40 transition-colors">
                                <td class="whitespace-nowrap px-4 py-3.5 text-gray-900 dark:text-white">
                                    ...
                                    <div
                                        class="text-xs text-gray-500 dark:text-gray-400 mt-1 font-normal flex items-center">
                                    ...
                                    <div
                                        class="text-xs text-gray-500 dark:text-gray-400 mt-0.5 font-normal flex items-center">
                                ...
                                <td class="whitespace-nowrap px-4 py-3 text-center align-middle">
                                    ...
                                    @endphp
                                    <span
                                        class="flex justify-center items-center rounded-full px-2 py-1 text-xs font-semibold {{ $badgeBg }} {{ $badgeText }} {{ $badgeBorder }}">
                                        {!! $iconSvg !!}{{ $badgeLabel }}
                                    </span>
                                </td>
                                <td class="whitespace-nowrap px-4 py-3.5 text-gray-900 dark:text-white">
