        ...
        <div class="flex-1 overflow-y-auto p-7">
            <div class="grid gap-6 h-full items-stretch md:grid-cols-[300px_1fr]">
                <div class="flex flex-col justify-between items-start h-full">
                    <div>
                        <label
                            class="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400 mt-1 mb-2">Gambar
                            Barang</label>
                ...
                <div class="flex flex-col justify-between h-full">
                    <div>
                        <div class="space-y-5">
                            <div class="space-y-2">
                                <label class="text-xs font-bold uppercase tracking-wider text-slate-400">Nama
                                    Barang</label>
                            ...
                            <div class="space-y-2">
                                <label
                                    class="text-xs font-bold uppercase tracking-wider text-slate-400">Deskripsi</label>
