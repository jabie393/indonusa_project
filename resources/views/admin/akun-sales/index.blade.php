<x-app-layout>
    <div class="inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm relative mb-5 flex justify-between overflow-hidden rounded-2xl bg-white shadow-md dark:bg-gray-800">
        <div class="p-4">
            <button onclick="createUserModal.showModal()" class="flex cursor-pointer items-center justify-center rounded-lg bg-[#1c4d81] px-4 py-2 text-sm font-medium text-white hover:bg-[#0D223A] focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-[#225A97] dark:focus:ring-primary-800">
