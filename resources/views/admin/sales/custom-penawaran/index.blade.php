                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4 text-center">
                                ...
                                @if ($hasBelow && $hasAbove)
                                    <span
                                        class="badge inset-ring inset-ring-orange-600 inline-flex items-center bg-orange-50 px-2 py-0.5 text-xs font-bold text-orange-700">
                                        &lt;20% &amp; &gt;20%
                                    </span>
                                @elseif ($hasAbove)
                                    <span
                                        class="badge inset-ring inset-ring-red-600 inline-flex items-center bg-red-50 px-2 py-0.5 text-xs font-bold text-red-700">
                                        &gt;20%
                                    </span>
                                @elseif ($hasBelow)
                                    <span
                                        class="badge inset-ring inset-ring-green-600 inline-flex items-center bg-green-50 px-2 py-0.5 text-xs font-bold text-green-700">
                                        &lt;20%
                                    </span>
                                @else
                                ...
                                @php
                                    $statusClass =
                                        [
                                            ...
                                            'pending_approval' =>
                                                'bg-orange-50 text-orange-800 inset-ring inset-ring-orange-600',
                                            'open' => 'bg-blue-50 text-blue-700 inset-ring inset-ring-blue-700',
                                            'sent_to_warehouse' =>
                                                'bg-indigo-50 text-indigo-700 inset-ring inset-ring-indigo-700',
                                            'sent_to_penawaran' =>
                                                'bg-indigo-50 text-indigo-700 inset-ring inset-ring-indigo-700',
                                        ...
                                        <ul class="dropdown dropdown-end menu rounded-box bg-base-100 w-52 shadow-sm"
                                            ...
                                            @if ($penawaran->status === 'approved_supervisor')
                                                <form
                                                    ...
                                                    <li>
                                                        <button type="button"
                                                            onclick="confirmApprove(() => this.closest('form').submit(), 'Kirim Penawaran ini ke Warehouse?', 'Ya, Kirim')"
                                            ...
                                            @if (in_array($penawaran->status, ['open', 'approved_supervisor']))
                                                <form
                                                    action="{{ route('sales.custom-penawaran.sent-to-penawaran', $penawaran->id) }}"
                                                    method="POST" style="display:inline;">
                                                    @csrf
                                                    <li>
                                                        <button type="button"
