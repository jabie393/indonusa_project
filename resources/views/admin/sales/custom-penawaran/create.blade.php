    ...
    <div class="relative overflow-hidden rounded-2xl bg-white shadow-md dark:bg-gray-800">
        <div class="flex flex-col items-center justify-between space-y-3 p-4 md:flex-row md:space-x-4 md:space-y-0">
            <div>
                ...
                <p class="mt-2 text-gray-600">Buat penawaran kustom untuk customer</p>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                        ...
                        <div class="mb-8 grid grid-cols-1 gap-6 p-5 lg:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" id="to" name="to" value="{{ old('to') }}" required
                                    class="@error('to') border-red-500 @enderror w-full rounded-lg px-4 py-2 focus:border-transparent focus:ring-2 focus:ring-blue-500" placeholder="Nama customer">
                                @error('to')
                            ...
                            <div>
                                ...
                                <input type="text" id="up" name="up" value="{{ old('up') }}"
                                    class="@error('up') border-red-500 @enderror w-full rounded-lg px-4 py-2 focus:border-transparent focus:ring-2 focus:ring-blue-500" placeholder="Nama PIC">
                                @error('up')
                                    <span class="mt-1 text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <input type="text" id="subject" name="subject" value="{{ old('subject') }}" required
                                    class="@error('subject') border-red-500 @enderror w-full rounded-lg px-4 py-2 focus:border-transparent focus:ring-2 focus:ring-blue-500"
                            ...
                            <div>
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email') }}" required
                                    class="@error('email') border-red-500 @enderror w-full rounded-lg px-4 py-2 focus:border-transparent focus:ring-2 focus:ring-blue-500"
                            ...
                            <div>
                                <label for="our_ref" class="mb-2 block text-sm font-medium text-gray-700">Our Ref (Auto)</label>
                                <input type="text" id="our_ref" name="our_ref" value="{{ old('our_ref') }}" readonly
                                    class="@error('our_ref') border-red-500 @enderror w-full rounded-lg bg-gray-100 px-4 py-2" placeholder="Auto-generated">
                                @error('our_ref')
                                    <span class="mt-1 text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" id="date" name="date" value="{{ old('date', date('Y-m-d')) }}" required
                                    class="@error('date') border-red-500 @enderror w-full rounded-lg px-4 py-2 focus:border-transparent focus:ring-2 focus:ring-blue-500">
                                @error('date')
                                    <span class="mt-1 text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <textarea id="intro_text" name="intro_text" rows="4" class="@error('intro_text') border-red-500 @enderror w-full rounded-lg px-4 py-2 focus:border-transparent focus:ring-2 focus:ring-blue-500"
                    ...
                    <div class="mb-8 rounded-lg bg-gray-50 p-6">
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                            ...
                            <div>
                                ...
                                <input type="text" id="subtotal-display" readonly class="w-full rounded-lg bg-gray-100 px-4 py-2 text-right font-semibold" value="0">
                            ...
                            <div>
                                ...
                                <input type="number" id="tax" name="tax" value="{{ old('tax', 0) }}" step="0.01" min="0"
                                    class="w-full rounded-lg px-4 py-2 focus:border-transparent focus:ring-2 focus:ring-blue-500" placeholder="0">
                            </div>

                            <!-- Grand Total -->
                            <div>
                                <label class="mb-2 block text-sm font-medium text-gray-700">Grand Total (Rp)</label>
                                <input type="text" id="grand-total-display" readonly class="w-full rounded-lg bg-blue-50 px-4 py-2 text-right text-lg font-bold text-blue-600" value="0">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('btn-add-item').addEventListener('click', function() {
                ...
                newRow.innerHTML = `
            <td class="border border-gray-300 px-4 py-2 px-4 py-2 text-center item-no">${itemCount + 1}</td>
            <td class="px-4 py-2 border border-gray-300 px-4 py-2">
            ...
            <td class="border border-gray-300 px-4 py-2 px-4 py-2 text-right item-subtotal font-semibold">0</td>
            <td class="border border-gray-300 px-4 py-2 px-4 py-2 text-center">
                <div class="relative upload-btn-container">
                    ...
                    <button type="button" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-semibold">
                        Upload Gambar
                    </button>
                </div>
                <div class="item-images-preview mt-2 space-y-2 flex flex-wrap gap-2"></div>
            </td>
            <td class="border border-gray-300 px-4 py-2">
                <button type="button" class="btn btn-remove-item rounded-lg bg-red-500 text-white hover:bg-red-600">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
