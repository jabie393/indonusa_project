    ...
    <div class="inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm rounded-2xl bg-white shadow-md dark:bg-gray-800">
        <div class="flex items-center justify-between rounded-t-2xl bg-[#225A97] p-[1rem] text-white">
            ...
            <a href="{{ route('ga.sales-order.export', ['search' => $search]) }}"
               class="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-emerald-300 transition hover:bg-emerald-600">
                <svg xmlns="http://www.w3.org/2000/svg"
                     width="16"
                     height="16"
                     viewBox="0 0 24 24"
                                                    ...
                                                    <tr>
                                                        <td colspan="12"
                                                            ...
                                                            <p class="mt-1 text-sm">
                                                                @if ($search)
                                                                    Coba ubah kata kunci pencarian atau <a href="{{ route('ga.sales-order.index') }}"
