        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="border-b border-gray-300 bg-gray-100 dark:border-gray-600 dark:bg-gray-700">
                    <tr>
                        <th class="text-nowrap px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">No.PO</th>
                        <th class="text-nowrap px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">No. Request</th>
                        <th class="text-nowrap px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">No. Penawaran</th>
                        <th class="text-nowrap px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">No. SO</th>
                        <th class="text-nowrap px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">Tanggal</th>
                        <th class="text-nowrap px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">Customer</th>
                        <th class="text-nowrap px-4 py-3 text-center text-sm font-semibold text-gray-700 dark:text-gray-300">Jumlah Item</th>
                        <th class="text-nowrap px-4 py-3 text-right text-sm font-semibold text-gray-700 dark:text-gray-300">Total</th>
                        <th class="text-nowrap px-4 py-3 text-right text-sm font-semibold text-gray-700 dark:text-gray-300">Diskon</th>
                        <th class="text-nowrap px-4 py-3 text-center text-sm font-semibold text-gray-700 dark:text-gray-300">Status</th>
                        <th class="text-nowrap px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">Berlaku Sampai</th>
                        <th class="text-nowrap px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">Action</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700">
                        <td class="px-4 py-3">
                            <div class="flex flex-col gap-1">
                                ...
                                <span>{{ $row['no_po'] ?? '-' }}</span>
                                @endif
                                <div id="image-po-preview-{{ $row['id'] }}-{{ $row['type'] }}"
                                    class="mt-1">
                                    ...
                                    <div class="group relative inline-block">
                                        ...
                                        <button class="absolute -right-2 -top-2 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-white opacity-0 shadow-lg transition-opacity group-hover:opacity-100"
                                ...
                                <div id="pdf-po-preview-{{ $row['id'] }}-{{ $row['type'] }}"
                                    class="mt-1">
                                ...
                                <div class="absolute left-0 z-10 flex flex-row overflow-hidden rounded-lg border border-gray-300 bg-white shadow-sm dark:border-gray-600 dark:bg-gray-700">
                                    ...
                                    <div id="image-preview-aksi-{{ $row['id'] }}-sales_order">
                                        ...
                                        <div class="group relative inline-block">
                                            ...
                                            @if (($row['customer_status'] ?? 'active') === 'active')
                                            <button class="absolute -right-1.5 -top-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-red-500 text-white opacity-0 shadow-sm transition-opacity group-hover:opacity-100"
                                    ...
                                    <ul class="dropdown dropdown-end menu rounded-box bg-base-100 w-52 shadow-sm"
                                        ...
                                        @php
                                        $sudahDikirim = in_array($row['status'], ['sent_to_warehouse', 'completed', 'not_completed', 'Dikirim ke Gudang', 'Disetujui Gudang', 'Selesai', 'Tidak Selesai']);
                                        @endphp
        ...
        <div class="flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-gray-800">
            ...
            <div class="flex items-center justify-between bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-white">
                ...
                <button id="closeModal"
                    class="rounded-full p-2 text-white transition hover:bg-blue-700">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
