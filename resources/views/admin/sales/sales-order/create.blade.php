<x-app-layout>
    <div class="inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm relative overflow-hidden rounded-2xl bg-white shadow-md dark:bg-gray-800">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('sales.sales-order.store') }}"
                      method="POST"
                        ...
                        <div class="mb-8 grid grid-cols-1 gap-6 p-5 lg:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select id="up"
                                    ...
                                    @foreach ($salesUsers as $name => $displayName)
                                        <option value="{{ $name }}"
                                                {{ old('up', $currentUserName ?? '') == $name ? 'selected' : '' }}>
                                            {{ $displayName }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <textarea id="intro_text"
                                          ...
                                          placeholder="Masukkan teks pembuka...">{{ old('intro_text', '') }}</textarea>
                                @error('intro_text')
                                    <span class="mt-1 text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <table id=""
                                ...
                                <thead>
                                    <tr class="bg-gray-200 dark:bg-gray-700">
                                        ...
                                        <th class="min-w-[80px] border border-gray-300 px-4 py-2 text-sm font-semibold text-black dark:border-gray-600 dark:text-gray-100">Action</th>
                                    </tr>
                                </thead>
                                <tbody id="items-container">
                                    <tr class="item-row"
                                        ...
                                        <td class="border border-gray-300 px-4 py-2 dark:border-gray-600">
                                            <button type="button"
                                                    class="btn btn-remove-item rounded-lg border-none bg-red-500 text-white hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                     width="24"
                                                     height="24"
                                                     viewBox="0 0 24 24"
