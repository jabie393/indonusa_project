                                    ...
                                    <tr class="border-t border-slate-200 dark:border-slate-700">
                                        ...
                                        <td class="px-4 py-3 text-right">
                                            ...
                                            <a href="{{ $batchInvoiceUrl }}"
                                               target="_blank"
                                               class="inline-flex items-center justify-center rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-700">
                                                Invoice
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                <div>
                                                    ...
                                                    @foreach ($batches as $batchItem)
                                                        <tr style="border-top:1px solid #e2e8f0;">
                                                            ...
                                                            <td style="padding:12px; vertical-align:top; text-align:right;">
                                                                ...
                                                                <a href="{{ $batchInvoiceUrl }}"
                                                                   target="_blank"
                                                                   style="display:inline-block; padding:10px 16px; border-radius:8px; background:#0f172a; color:#ffffff; text-decoration:none; font-weight:700;">Invoice</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                    ...
                                    <div style="margin-top: 24px;">
                                        ...
                                        <p id="preview_customer"
                                           style="font-weight: bold; font-size: 16px; font-family: 'Times New Roman', serif; margin: 0 0 4px 0;">{{ strtoupper($customerName) }}</p>
                                        <p id="preview_address"
                                           style="margin: 0 0 8px 0; line-height: 1.6; color: #000000; font-size: 16px; font-family: 'Times New Roman', serif;">{{ $customerAddress ?: '-' }}</p>
                                        <span id="preview-npwp"
                                              style="font-size: 16px; color: #000000; font-family: 'Times New Roman', serif;">NPWP&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <span>{{ old('inv_npwp', $customerNpwp) }}</span></span>
                                    </div>
                                </div>
                            ...
                            <div style="margin-top: 32px; display: flex; justify-content: space-between;">
                                <div style="border:3px solid #000000; border-radius:8px; padding:12px; max-width:340px; font-family: 'Times New Roman', serif; font-size: 16px; color: #000000;">
                                    ...
                                    <span id="preview-payment-note"
                                          style="line-height: 1.6; color: #000000; font-size: 16px;">• BCA a/c. 7881213501<br> a/n. PT. Indonusa Jaya Bersama<br><br>Thank you for your support.<br>We look forward to serve you again</span>
                                </div>
                    ...
                    <div class="gap-2 lg:col-span-1">
                        ...
                        <div class="no-print sticky top-5 space-y-6 lg:col-span-1">
                            <div class="overflow-hidden rounded-xl border border-gray-100 bg-white shadow-md dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <div class="flex flex-col gap-3 rounded-xl bg-white p-6 shadow">
                                    <button type="button"
                                            id="btn-print"
                                            class="flex w-full items-center justify-center space-x-2 rounded-xl bg-emerald-600 py-2.5 text-xs font-bold text-white shadow-lg shadow-emerald-200 transition-all hover:bg-emerald-700 hover:shadow-none dark:shadow-none">Cetak PDF</button>
                                    <button type="button"
                                            id="btn-excel"
                                            class="flex w-full items-center justify-center space-x-2 rounded-xl bg-emerald-600 py-2.5 text-xs font-bold text-white shadow-lg shadow-emerald-200 transition-all hover:bg-emerald-700 hover:shadow-none dark:shadow-none">Download Excel</button>
                                </div>
                            </div>
                            ...
                            <div class="overflow-hidden rounded-xl border border-gray-100 bg-white shadow-md dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <div class="space-y-3 p-6">
                                    ...
                                    <input type="text"
                                           id="inv_number"
                                           name="inv_number"
                                           class="w-full cursor-not-allowed rounded border-gray-300 bg-gray-100 p-2 text-gray-600 dark:bg-gray-700 dark:text-gray-400"
                                           value="{{ $invoiceNumber }}"
                                           readonly>
                                    ...
                                    <textarea id="inv_payment_note"
                                              name="inv_payment_note"
                                              rows="4"
                                              class="w-full rounded border-gray-300 p-2">• BCA a/c. 7881213501
                        ...
                        We look forward to serve you again
                                    ...
                                    <button type="button"
                                            ...
                                            class="mt-4 w-full rounded bg-blue-600 py-2 font-bold text-white">🔄 Update Preview</button>
                                    <div id="update-toast"
                                         style="display:none;"
                                         class="mt-2 rounded-lg border border-green-400 bg-green-100 px-4 py-2 text-center text-sm font-semibold text-green-700">
                                        ✅ Berhasil diupdate
                                    </div>
                                </div>
                            </div>
