                                ...
                                <div class="flex flex-col items-center gap-1">
                                    ...
                                    @if ($orderStatus === 'not_completed' && $ro->order)
                                        @php
                                            ...
                                            $sudahDikirim = $orderItems->filter(
                                                fn($i) => ($i->delivered_quantity ?? 0) > 0,
                                            );
                                            $belumDikirim = $orderItems->filter(
                                                fn($i) => ($i->delivered_quantity ?? 0) < $i->quantity &&
                                                    ($i->status_item ?? '') !== 'delivered',
                                            );
                                        @endphp
