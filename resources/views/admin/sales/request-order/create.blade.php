                    ...
                    <div class="card bg-light bg-card inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm mb-4 rounded-2xl shadow-sm">
                        ...
                        <div class="mb-8 grid grid-cols-1 gap-6 p-5 lg:grid-cols-2">
                            ...
                            <div class="col-span-2 flex flex-col">
                                <label for="customer_id" class="form-label text-gray-700 dark:text-gray-300">Pilih Customer <span class="text-danger">*</span></label>
                            ...
                            <div class="col-span-2 flex flex-col md:col-span-1">
                                <label for="customer_name" class="form-label text-gray-700 dark:text-gray-300">Nama Customer</label>
                            ...
                            <div class="col-span-2 flex flex-col md:col-span-1">
                                <label for="pic_id" class="form-label text-gray-700 dark:text-gray-300">PIC (Sales) <span class="text-danger">*</span></label>
                            ...
                            <div class="col-span-2 flex flex-col md:col-span-1">
                                <label for="no_po" class="form-label text-gray-700 dark:text-gray-300">No. PO</label>
                                <input type="text" class="@error('no_po') is-invalid @enderror block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400" id="no_po" name="no_po" value="{{ old('no_po') }}" placeholder="Masukkan No. PO">
                                @error('no_po')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-span-2 flex flex-col md:col-span-1">
                                ...
                                <input type="text" class="@error('sales_order_number') is-invalid @enderror block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400" id="sales_order_number" name="sales_order_number" value="{{ old('sales_order_number') }}" placeholder="Masukkan No. SO">
                            ...
                            <table class="h-full w-full border-collapse" id="itemsTable">
                                <thead>
                                    <tr class="bg-gray-200 dark:bg-gray-700">
                                        <th class="min-w-[150px] border border-gray-300 px-4 py-2 text-sm font-semibold text-black dark:border-gray-600 dark:text-gray-100">
                                            Kategori Barang</th>
                                        <th class="min-w-[150px] border border-gray-300 px-4 py-2 text-sm font-semibold text-black dark:border-gray-600 dark:text-gray-100">
                                            Kode Barang</th>
                                        <th class="min-w-[250px] border border-gray-300 px-4 py-2 text-sm font-semibold text-black dark:border-gray-600 dark:text-gray-100">
                                            Nama Barang</th>
                                        <th class="min-w-[100px] border border-gray-300 px-4 py-2 text-sm font-semibold text-black dark:border-gray-600 dark:text-gray-100">
                                            Diskon (%)</th>
                                        <th class="min-w-[200px] border border-gray-300 px-4 py-2 text-sm font-semibold text-black dark:border-gray-600 dark:text-gray-100">
                                            Keterangan</th>
                                        <th class="min-w-[100px] border border-gray-300 px-4 py-2 text-sm font-semibold text-black dark:border-gray-600 dark:text-gray-100">
                                            Jumlah</th>
                                        <th class="min-w-[180px] border border-gray-300 px-4 py-2 text-sm font-semibold text-black dark:border-gray-600 dark:text-gray-100">
                                            Harga Satuan</th>
                                        <th class="min-w-[150px] border border-gray-300 px-4 py-2 text-sm font-semibold text-black dark:border-gray-600 dark:text-gray-100">
                                            Gambar</th>
                                        <th class="min-w-[180px] border border-gray-300 px-4 py-2 text-sm font-semibold text-black dark:border-gray-600 dark:text-gray-100">
                                            Harga Setelah Diskon</th>
                                        <th class="min-w-[80px] border border-gray-300 px-4 py-2 text-sm font-semibold text-black dark:border-gray-600 dark:text-gray-100">
                                            Aksi</th>
                                    </tr>
                                </thead>
                                <tbody id="itemRows">
                ...
                <div class="modal-content">
                    ...
                    <form id="addCustomerForm" method="POST">
                        ...
                        <div class="modal-body">
                            <!-- Nama Customer -->
                            <div class="mb-3">
                                <label for="modalNamaCustomer" class="form-label text-gray-700 dark:text-gray-300">Nama Customer
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="modalEmail" class="form-label text-gray-700 dark:text-gray-300">Email</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="modalTelepon" class="form-label text-gray-700 dark:text-gray-300">Telepon</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="modalTipeCustomer" class="form-label text-gray-700 dark:text-gray-300">Tipe
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="modalStatus" class="form-label text-gray-700 dark:text-gray-300">Status <span class="text-danger">*</span></label>
                            ...
                            <!-- Alamat -->
                            <div class="mb-3">
                                <label for="modalAlamat" class="form-label text-gray-700 dark:text-gray-300">Alamat</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="modalKota" class="form-label text-gray-700 dark:text-gray-300">Kota</label>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="modalProvinsi" class="form-label text-gray-700 dark:text-gray-300">Provinsi</label>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="modalKodePos" class="form-label text-gray-700 dark:text-gray-300">Kode
                                            Pos</label>
