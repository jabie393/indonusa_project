                ...
                <form method="POST" action="{{ route('sales.request-order.store') }}" id="requestOrderForm"
                    ...
                    <div
                        ...
                        <div class="mb-8 grid grid-cols-1 gap-6 p-5 lg:grid-cols-2">
                            ...
                            <div class="col-span-2 flex flex-col">
                                <label for="subject" class="form-label text-gray-700 dark:text-gray-300">Subject <span
                ...
                <div class="modal-content">
                    ...
                    <form id="addCustomerForm" method="POST">
                        ...
                        <div class="modal-body">
                            <!-- Nama Customer -->
                            <div class="mb-3">
                                <label for="modalNamaCustomer"
                                    class="form-label text-gray-700 dark:text-gray-300">Nama Customer
                                    <span class="text-danger">*</span></label>
                                <input type="text"
                                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="modalTipeCustomer"
                                            class="form-label text-gray-700 dark:text-gray-300">Tipe
                                            Customer <span class="text-danger">*</span></label>
                                        <select
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="modalStatus"
                                            class="form-label text-gray-700 dark:text-gray-300">Status <span
                                                class="text-danger">*</span></label>
                                        <select
                                            class="form-select dark:border-gray-500 dark:bg-gray-600 dark:text-white"
                            ...
                            <!-- Alamat -->
                            <div class="mb-3">
                                <label for="modalAlamatPenagihan"
                                    class="form-label text-gray-700 dark:text-gray-300">Alamat Penagihan</label>
                                <textarea
                                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400"
                                    id="modalAlamatPenagihan" name="alamat_penagihan" rows="2"></textarea>
                                <div class="invalid-feedback" id="error-alamat_penagihan"></div>
                            </div>

                            <div class="mb-3">
                                <label for="modalAlamatPengiriman"
                                    class="form-label text-gray-700 dark:text-gray-300">Alamat Pengiriman</label>
                                <textarea
                                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400"
                                    id="modalAlamatPengiriman" name="alamat_pengiriman" rows="2"></textarea>
                                <div class="invalid-feedback" id="error-alamat_pengiriman"></div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="modalProvinsi"
                                            class="form-label text-gray-700 dark:text-gray-300">Provinsi</label>
                                        <input type="text"
                                            class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400"
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="modalKodePos"
                                            class="form-label text-gray-700 dark:text-gray-300">Kode
                                            Pos</label>
                                        <input type="text"
                                            class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400"
