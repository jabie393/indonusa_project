    ...
    <div class="container-fluid px-4">
        <div class="row mb-4">
            <div class="col">
                ...
                <p class="text-muted">Daftarkan customer baru ke sistem</p>
            </div>
            <div class="col-auto">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('sales.customer.store') }}">
                            @csrf
                ...
                <div class="card bg-info text-white">
                    <div class="card-body">
                        ...
                        <p class="card-text small">
                            Isi data customer dengan lengkap agar memudahkan saat membuat Request Order dan Sales Order.
                        </p>
