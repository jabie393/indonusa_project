                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="custom-wilayah-container province-dropdown-container relative">
                            ...
                            <input type="hidden" id="edit_province" name="province" value="">

                            <!-- Trigger Button -->
                            <button type="button" id="edit_province_btn"
                        ...
                        <div class="custom-wilayah-container city-dropdown-container relative">
                            ...
                            <!-- Hidden input for form submission -->
                            <input type="hidden" id="edit_city" name="city" value="">

                            <!-- Trigger Button (Starts Disabled) -->
                            <button type="button" id="edit_city_btn" disabled
