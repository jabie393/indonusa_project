                    ...
                    @foreach ($pics as $pic)
                        <tr class="dark:border-gray-700">
                            ...
                            <td class="flex items-center px-4">
                                <button class="editPicsButton mb-2 me-2 rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" data-id="{{ $pic->id }}" data-name="{{ $pic->name }}" data-phone="{{ $pic->phone }}" data-email="{{ $pic->email }}" data-position="{{ $pic->position }}">
                                    Edit
                                </button>
