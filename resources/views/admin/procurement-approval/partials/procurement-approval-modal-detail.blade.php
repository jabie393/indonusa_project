                ...
                <div class="flex flex-col justify-between items-start h-full">
                    <div>
                        ...
                        <div id="detail_image_container"
                            ...
                            <div id="detail_image_placeholder"
                                class="flex h-full w-full items-center justify-center text-slate-300 z-10">
                    ...
                    <div
                        class="rounded-2xl border border-slate-100 bg-slate-50/50 p-4 mt-1 md:mt-0 w-full md:w-[280px] md:ml-0 dark:border-gray-700 dark:bg-gray-700/50">
                        <label
                        ...
                        <p class="text-sm font-medium text-slate-700 dark:text-gray-300" id="detail_status">-</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col justify-between h-full">
                    <div>
                        <div class="space-y-5">
                            <div class="space-y-2">
                                ...
                                <div class="text-lg font-bold text-slate-800 dark:text-white" id="detail_nama_display">-</div>
                            </div>

                            <div class="space-y-2">
                                <label
                                    class="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400"
                                    for="detail_deskripsi">
                                    <svg fill="none" height="14" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="14"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="min-h-[60px] text-sm leading-relaxed text-slate-600 dark:text-gray-300 italic"
                                    id="detail_deskripsi">-</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div class="rounded-2xl border border-slate-100 bg-slate-50/50 p-4 dark:border-gray-700 dark:bg-gray-700/50">
                                <label
                                    class="mb-1 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400">
                                    <svg fill="none" height="14" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="14"
                                ...
                                <p class="text-sm font-mono font-bold text-slate-800 dark:text-white" id="detail_kode_display">-</p>
                            </div>
                            <div class="rounded-2xl border border-slate-100 bg-slate-50/50 p-4 dark:border-gray-700 dark:bg-gray-700/50">
                                <label
                                    class="mb-1 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400">
                                ...
                                <p class="text-sm font-medium text-slate-700 dark:text-gray-300" id="detail_kategori">-</p>
                            </div>
                            <div class="rounded-2xl border border-slate-100 bg-slate-50/50 p-4 dark:border-gray-700 dark:bg-gray-700/50">
                                <label
                                    class="mb-1 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400">
                                ...
                                <p class="text-sm font-bold text-blue-600 dark:text-blue-400" id="detail_stock">-</p>
                            </div>
                            <div class="rounded-2xl border border-slate-100 bg-slate-50/50 p-4 dark:border-gray-700 dark:bg-gray-700/50">
                                <label
                                    class="mb-1 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400">
                                ...
                                <p class="text-sm font-medium text-slate-700 dark:text-gray-300" id="detail_unit">-</p>
                            </div>
                            <div class="rounded-2xl border border-slate-100 bg-slate-50/50 p-4 dark:border-gray-700 dark:bg-gray-700/50">
                                <label
                                    class="mb-1 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400">
                                ...
                                <p class="text-sm font-medium text-slate-700 dark:text-gray-300" id="detail_location">-</p>
                            </div>
                            <div class="rounded-2xl border border-slate-100 bg-slate-50/50 p-4 dark:border-gray-700 dark:bg-gray-700/50">
                                <label
                                    class="mb-1 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400">
                                ...
                                <p class="text-sm font-medium text-slate-700 dark:text-gray-300" id="detail_selling_price">-</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    function openDetailModal(data) {
        ...
        if (img && placeholder) {
            if (data.gambar) {
                const src = (data.gambar.startsWith('http') || data.gambar.startsWith('/') || data.gambar.startsWith('storage/'))
                    ? data.gambar
                    : 'files/' + data.gambar;
                img.src = src;
        ...
        document.querySelectorAll('.view-detail-btn').forEach(btn => {
            btn.addEventListener('click', function(e) {
                ...
                const data = {
                    ...
                    selling_price: this.dataset.harga || this.dataset.selling_price
                };
