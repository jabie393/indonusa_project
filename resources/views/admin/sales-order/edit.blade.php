<x-app-layout>
    <div class="inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm relative overflow-hidden rounded-2xl bg-white shadow-md dark:bg-gray-800">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('sales.sales-order.update', $salesOrder) }}"
                      method="POST"
                        ...
                        <div class="mb-8 grid grid-cols-1 gap-6 p-5 lg:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select id="up"
                                    ...
                                    @foreach ($salesUsers as $name => $displayName)
                                        <option value="{{ $name }}"
                                                {{ old('up', $salesOrder->up) == $name ? 'selected' : '' }}>
                                            {{ $displayName }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <input type="text"
                                       id="subject"
                                       name="subject"
                                       value="{{ old('subject', $salesOrder->subject) }}"
                                       required
                            ...
                            <div>
                                ...
                                <input type="email"
                                       id="email"
                                       name="email"
                                       value="{{ old('email', $salesOrder->email) }}"
                                       required
                            ...
                            <div>
                                ...
                                <input type="text"
                                       id="our_ref"
                                       name="our_ref"
                                       value="{{ old('our_ref', $salesOrder->our_ref) }}"
                            ...
                            <div>
                                ...
                                <input type="date"
                                       id="date"
                                       name="date"
                                       value="{{ old('date', $salesOrder->date?->format('Y-m-d')) }}"
                                       required
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <textarea id="intro_text"
                                          ...
                                          placeholder="Masukkan teks pembuka...">{{ old('intro_text', $salesOrder->intro_text) }}</textarea>
                                @error('intro_text')
                                    <span class="mt-1 text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                                    ...
                                    @forelse ($salesOrder->items as $item)
                                        <tr class="item-row"
                                            ...
                                            <td class="border border-gray-300 px-4 py-2 dark:border-gray-600">
                                                <input type="text"
                                                       name="items[{{ $loop->index }}][nama_barang]"
                                            ...
                                            <td class="border border-gray-300 px-4 py-2 text-center">
                                                        ...
                                                        @foreach ($item->images as $image)
                                                            <div class="relative inline-block">
                                                                <img src="{{ asset('storage/' . $image) }}"
                                                                     ...
                                                                     title="{{ $image }}">
                                                                <button type="button"
                                                                        class="remove-existing-image-btn absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full bg-red-500 text-xs text-white hover:bg-red-600"
                                                                        data-image="{{ $image }}">
                                                                    ✕
                                                                </button>
                                                            </div>
                                                ...
                                                <input type="hidden"
                                                       name="items[{{ $loop->index }}][existing_images]"
                                                       class="existing-images-input"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="w-full">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="Rp {{ number_format($salesOrder->subtotal, 0, '.', ',') }}">
                                            <input type="hidden"
                                                   id="subtotal-value"
                                                   name="subtotal"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="w-full">
                                            ...
                                            <input type="text"
                                                   ...
                                                   readonly
                                                   class="mt-1 w-full border-none bg-transparent p-0 text-2xl font-bold text-gray-900 focus:ring-0 dark:text-white"
                                                   value="Rp {{ number_format($salesOrder->tax, 0, '.', ',') }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="w-full">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="Rp {{ number_format($salesOrder->grand_total, 0, '.', ',') }}">
                                            <input type="hidden"
                                                   id="grand-total-value"
                                                   name="grand_total"
                                                   value="{{ $salesOrder->grand_total }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-4 flex justify-end gap-4">
                        <a href="{{ route('sales.sales-order.show', $salesOrder) }}"
