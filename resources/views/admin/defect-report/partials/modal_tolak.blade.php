                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h5 id="modalTolakTitle" class="text-lg font-bold tracking-tight text-white">
                            Tolak Pengajuan Defect
                        </h5>
                        <p class="mt-1 text-xs font-medium text-rose-100/80">Nama Barang: <span id="modalTolakNama"></span></p>
                    </div>
                ...
                <div class="px-7 py-6">
                    <div class="mb-5 rounded-lg border border-amber-100 bg-amber-50 p-3">
                        <div class="flex space-x-2">
                            ...
                            <p class="text-[11px] font-medium leading-relaxed text-amber-800">Penolakan akan mengubah status pengajuan menjadi 'Ditolak Supervisor' agar dapat diperbaiki
                                dan diajukan ulang oleh Warehouse.</p>
                        </div>
                    </div>
    ...
    <script>
         ...
         * @param {string} nama - Nama barang / request number (untuk label)
         */
        function openTolakModal(type, id, nama) {
            ...
            document.getElementById('modalTolakNama').textContent = nama;
