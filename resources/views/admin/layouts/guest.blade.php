...
<body
    class="grid overflow-y-scroll min-h-screen grid-cols-1 grid-rows-6 gap-4 p-5 font-sans text-gray-900 antialiased lg:grid-cols-5 lg:grid-rows-1">
    ...
    <div
        class="bg-linear-to-r min-h-fit rounded-4xl row-span-3 row-start-4 flex h-full flex-col items-center bg-[#E5E7EB] sm:justify-center lg:col-span-3 lg:col-start-3 lg:row-span-full">
