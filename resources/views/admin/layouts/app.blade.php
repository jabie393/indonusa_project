...
<body class="font-sans antialiased">
    <div
        ...
        <div
            class="z-50 col-span-1 col-start-1 row-span-1 row-start-1 flex items-center justify-center rounded-xl bg-[#225A97] dark:bg-[#0D223A]">
            <div class="flex items-center h-full w-full lg:h-[unset] shadow-sm justify-center ">
        ...
        <div
            class="col-span-5 col-start-1 row-span-4 row-start-2 overflow-scroll no-scrollbar rounded-xl lg:col-span-4 lg:col-start-2">
            {{ $slot }}
        </div>
    </div>
