...
<head>
    ...
    <!-- Bootstrap 5 JS agar modal berfungsi -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>


    {{-- DataTable --}}
    <link href="https://cdn.datatables.net/v/zf/jszip-3.10.1/dt-2.3.5/af-2.7.1/b-3.2.5/b-colvis-3.2.5/b-html5-3.2.5/b-print-3.2.5/cr-2.1.2/cc-1.1.1/date-1.6.2/fc-5.0.5/fh-4.0.5/kt-2.12.2/r-3.0.7/rg-1.6.0/rr-1.5.0/sc-2.4.3/sb-1.8.4/sp-2.3.5/sl-3.1.3/sr-1.4.3/datatables.min.css"
          rel="stylesheet"
          integrity="sha384-RtnchH+olPfoFh06ZUdy5mHOMxw9/roHRmRlLKBJVAiQzEtQSfiX1sWgMrrlXTIe"
...
<body data-user-role="{{ $userRole }}"
    ...
    <div class="grid max-h-screen min-h-screen grid-flow-row grid-cols-[1.3fr_1fr_1fr_1fr_1fr] grid-rows-[64px_1fr_1fr_1fr_1fr] gap-4 overflow-hidden bg-[#E5E7EB] p-4 dark:bg-gray-900 xl:grid-cols-[1fr_1fr_1fr_1fr_1fr] 2xl:grid-cols-[0.8fr_1fr_1fr_1fr_1fr]">
        <div class="inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm z-50 col-span-1 col-start-1 row-span-1 row-start-1 flex items-center justify-center rounded-xl bg-[#225A97] dark:bg-[#0D223A]">
            <div class="flex h-full w-full items-center justify-center lg:h-[unset]">
                ...
                <a href="{{ route('dashboard') }}"
                   class="mr-4 hidden items-center justify-between lg:flex">
    ...
    <div id="notification-container"
         class="fixed right-4 top-4 z-50 hidden rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-white shadow-lg">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/vfs_fonts.js"
            ...
            crossorigin="anonymous"></script>
    <script src="https://cdn.datatables.net/v/zf/jszip-3.10.1/dt-2.3.5/af-2.7.1/b-3.2.5/b-colvis-3.2.5/b-html5-3.2.5/b-print-3.2.5/cr-2.1.2/cc-1.1.1/date-1.6.2/fc-5.0.5/fh-4.0.5/kt-2.12.2/r-3.0.7/rg-1.6.0/rr-1.5.0/sc-2.4.3/sb-1.8.4/sp-2.3.5/sl-3.1.3/sr-1.4.3/datatables.min.js"
            integrity="sha384-Qqo2BXySTT0KiB7yPTOOsf2DPibBoanEFBmbYpif+dj/RI9uBph6NSTpfq1m1eDM"
            crossorigin="anonymous"></script>
