...
<body data-user-role="{{ $userRole }}" class="font-sans antialiased">
    ...
    <script>
        window.sweetTitle = @json(session('title') ?? session('success'));
        window.sweetText = @json(session('text') ?? (session('message') ?? session('status')));
        window.errorTitle = @json(session('error_title') ?? session('error'));
        window.errorText = @json(session('error_text') ?? session('message'));
    </script>

    {{-- DataTable --}}
    <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/pdfmake.min.js" integrity="sha384-VFQrHzqBh5qiJIU0uGU5CIW3+OWpdGGJM9LBnGbuIH2mkICcFZ7lPd/AAtI7SNf7" crossorigin="anonymous"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/vfs_fonts.js" integrity="sha384-/RlQG9uf0M2vcTw3CX7fbqgbj/h8wKxw7C3zu9/GxcBPRKOEcESxaxufwRXqzq6n" crossorigin="anonymous"></script>
    <script src="https://cdn.datatables.net/v/zf/jszip-3.10.1/dt-2.3.5/af-2.7.1/b-3.2.5/b-colvis-3.2.5/b-html5-3.2.5/b-print-3.2.5/cr-2.1.2/cc-1.1.1/date-1.6.2/fc-5.0.5/fh-4.0.5/kt-2.12.2/r-3.0.7/rg-1.6.0/rr-1.5.0/sc-2.4.3/sb-1.8.4/sp-2.3.5/sl-3.1.3/sr-1.4.3/datatables.min.js" integrity="sha384-Qqo2BXySTT0KiB7yPTOOsf2DPibBoanEFBmbYpif+dj/RI9uBph6NSTpfq1m1eDM" crossorigin="anonymous"></script>
