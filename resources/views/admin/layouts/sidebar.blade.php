<!-- Sidebar -->
<aside class="mt-22 fixed left-0 top-0 z-40 h-full w-64 -translate-x-full rounded-xl shadow-sm transition-transform lg:relative lg:mt-0 lg:w-full lg:translate-x-0" aria-label="Sidenav" id="drawer-navigation">
    <div class="inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm h-full overflow-y-auto rounded-xl bg-white px-3 py-5 dark:bg-[#0D223A]">
        ...
        <ul class="space-y-2">
            ...
            <li>
                <a href="{{ route('dashboard') }}" class="{{ request()->routeIs('dashboard') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                    <svg aria-hidden="true" class="{{ request()->routeIs('dashboard') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 transition duration-75 group-hover:text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                        <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path>
                    </svg>
                    <span class="{{ request()->routeIs('dashboard') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Dashboard</span>
                </a>
            </li>
            ...
            @if (in_array(auth()->user()->role, ['General Affair']))
                {{-- Goods In --}}
                <li>
                    <a href="{{ route('goods-in.index') }}" class="{{ request()->routeIs('goods-in.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none" class="{{ request()->routeIs('goods-in.*') ? 'text-white' : 'text-black dark:text-white' }} group-hover:text-white">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.5 0.0795898L26.625 6.79129V20.2147L13.5 26.9264L0.375 20.2147V6.79129L13.5 0.0795898ZM9.12493 12.6078L9.125 21.7063L12.0417 23.1978V14.0993L9.12493 12.6078ZM3.29167 9.62501V18.7232L6.20831 20.2148V11.1164L3.29167 9.62501ZM19.2416 5.99859L10.6571 10.4086L13.5 11.8623L22.1042 7.46246L19.2416 5.99859ZM13.5 3.06257L4.89583 7.46246L7.7438 8.91877L16.3283 4.50884L13.5 3.06257Z" fill="currentColor" />
                        </svg>
                        <span class="{{ request()->routeIs('goods-in.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Goods
                            In</span>
                    </a>
                    {{-- Add Stock --}}
                    @if (request()->routeIs('add-stock.*'))
                        <ul class="pt-2">
                            <li class="flex items-center justify-end">
                                ...
                                <a href="{{ route('add-stock.index') }}" class="group ml-2 flex w-[75%] items-center rounded-lg bg-gradient-to-r from-[#225A97] to-[#0D223A] p-2 text-base font-medium text-white transition-all duration-200 hover:shadow-lg">
                    ...
                    @if (request()->routeIs('import-excel.*'))
                        <ul class="pt-2">
                            <li class="flex items-center justify-end">
                                ...
                                <a href="{{ route('import-excel.index') }}" class="group ml-2 flex w-[75%] items-center rounded-lg bg-gradient-to-r from-[#225A97] to-[#0D223A] p-2 text-base font-medium text-white transition-all duration-200 hover:shadow-lg">
                    ...
                    @if (request()->routeIs('import-stock-excel.*'))
                        <ul class="pt-2">
                            <li class="flex items-center justify-end">
                                ...
                                <a href="{{ route('import-stock-excel.index') }}" class="group ml-2 flex w-[75%] items-center rounded-lg bg-gradient-to-r from-[#225A97] to-[#0D223A] p-2 text-base font-medium text-white transition-all duration-200 hover:shadow-lg">
                ...
                {{-- Goods In Status --}}
                <li>
                    <a href="{{ route('goods-in-status.index') }}" class="{{ request()->routeIs('goods-in-status.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="29" viewBox="0 0 28 29" fill="currentColor" class="{{ request()->routeIs('goods-in-status.*') ? 'text-white' : 'text-black dark:text-white' }} group-hover:text-white">
                ...
                <details {{ request()->routeIs('akun-sales.*') || request()->routeIs('customer.*') || request()->routeIs('pics.*') ? 'open' : '' }} class="">
                    <summary class="{{ request()->routeIs('akun-sales.*') || request()->routeIs('customer.*') || request()->routeIs('pics.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex cursor-pointer items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                        ...
                        <svg width="28px" height="28px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="#000000" class="{{ request()->routeIs('akun-sales.*') || request()->routeIs('customer.*') || request()->routeIs('pics.*') ? 'text-white' : 'text-black dark:text-white' }} group-hover:text-white">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path fill="currentColor" d="M13.098 8H6.902c-.751 0-1.172.754-.708 1.268L9.292 12.7c.36.399 1.055.399 1.416 0l3.098-3.433C14.27 8.754 13.849 8 13.098 8Z">
                                </path>
                            </g>
                        </svg>
                    ...
                    <ul class="before:left-4.5 relative flex flex-col items-end space-y-2 pt-2 before:absolute before:bottom-[.75rem] before:start-0 before:top-[.75rem] before:w-1 before:bg-black before:opacity-10 before:content-[''] dark:before:bg-white">

                        {{-- Akun Sales --}}
                        <li class="w-[75%]">
                            <a href="{{ route('akun-sales.index') }}" class="{{ request()->routeIs('akun-sales.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="{{ request()->routeIs('akun-sales.*') ? 'text-white' : 'text-black dark:text-white' }} group-hover:text-white">
                                    <path
                                        ...
                                        fill="currentColor" />
                                    <path d="M22.4971 22.3652L18.1904 20.0889L17.4404 21.5098L22.4971 24.1816L27.5332 21.5215L26.7832 20.1006L22.4971 22.3652Z" fill="currentColor" />
                                    <path d="M22.4971 24.9434L18.1904 22.6699L17.4404 24.0879L22.4971 26.7627L27.5156 24.1084L26.7656 22.6875L22.4971 24.9434Z" fill="currentColor" />
                                </svg>

                                <span class="{{ request()->routeIs('akun-sales.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Akun
                                    Sales
                                </span>
                            </a>
                        </li>
                        ...
                        {{-- Customer --}}
                        <li class="w-[75%]">
                            <a href="{{ route('customer.index') }}" class="{{ request()->routeIs('customer.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="{{ request()->routeIs('customer.*') ? 'text-white' : 'text-black dark:text-white' }} group-hover:text-white">
                                    <path d="M23.3027 21.9639C23.8066 21.3252 24.1084 20.5195 24.1084 19.6406C24.1084 17.5693 22.4297 15.8906 20.3584 15.8906C18.2871 15.8906 16.6084 17.5693 16.6084 19.6406C16.6084 20.5166 16.9102 21.3252 17.4141 21.9639C15.3457 23.0332 13.9307 25.1924 13.9307 27.6768H16.0723C16.0723 25.3125 17.9941 23.3906 20.3584 23.3906C22.7227 23.3906 24.6445 25.3125 24.6445 27.6768H26.7861C26.7861 25.1953 25.3682 23.0361 23.3027 21.9639ZM20.3584 18.0352C21.2432 18.0352 21.9668 18.7559 21.9668 19.6436C21.9668 20.5283 21.2461 21.252 20.3584 21.252C19.4736 21.252 18.75 20.5312 18.75 19.6436C18.75 18.7559 19.4707 18.0352 20.3584 18.0352Z" fill="currentColor" />
                ...
                {{-- Goods Receipt --}}
                <li>
                    <a href="{{ route('goods-receipts.index') }}" class="{{ request()->routeIs('goods-receipts.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">

                        <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="{{ request()->routeIs('goods-receipts.*') ? 'text-white' : 'text-black dark:text-white' }} group-hover:text-white">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path d="M4 6.25C4 5.00736 5.00736 4 6.25 4H14.75C15.9926 4 17 5.00736 17 6.25V14H20.5V17.25C20.5 19.0449 19.0449 20.5 17.25 20.5H7.25C5.45507 20.5 4 19.0449 4 17.25V6.25ZM17 15.5V19H17.25C18.2165 19 19 18.2165 19 17.25V15.5H17ZM15.5 19V6.25C15.5 5.83579 15.1642 5.5 14.75 5.5H6.25C5.83579 5.5 5.5 5.83579 5.5 6.25V17.25C5.5 18.2165 6.2835 19 7.25 19H15.5Z" fill="currentColor"></path>
                                <path d="M7.00001 8.75C7.00001 8.33579 7.3358 8 7.75001 8H13.25C13.6642 8 14 8.33579 14 8.75C14 9.16422 13.6642 9.5 13.25 9.5H7.75001C7.3358 9.5 7.00001 9.16422 7.00001 8.75ZM7.00001 12.25C7.00001 11.8358 7.3358 11.5 7.75001 11.5H13.25C13.6642 11.5 14 11.8358 14 12.25C14 12.6642 13.6642 13 13.25 13H7.75001C7.3358 13 7.00001 12.6642 7.00001 12.25ZM7.00001 15.75C7.00001 15.3358 7.3358 15 7.75001 15H10.25C10.6642 15 11 15.3358 11 15.75C11 16.1642 10.6642 16.5 10.25 16.5H7.75001C7.3358 16.5 7.00001 16.1642 7.00001 15.75Z" fill="currentColor"></path>
                            </g>
                        </svg>
                        <span class="{{ request()->routeIs('goods-receipts.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Goods
                            Receipt</span>
                    </a>
                </li>
                ...
                {{-- History --}}
                <li>
                    <a href="{{ route('history.index') }}" class="{{ request()->routeIs('history.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                        <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="{{ request()->routeIs('history.*') ? 'text-white' : 'text-black dark:text-white' }} group-hover:text-white">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path
                                    ...
                                    fill="currentColor"></path>
                                <path d="M12 5C11.4477 5 11 5.44771 11 6V12.4667C11 12.4667 11 12.7274 11.1267 12.9235C11.2115 13.0898 11.3437 13.2344 11.5174 13.3346L16.1372 16.0019C16.6155 16.278 17.2271 16.1141 17.5032 15.6358C17.7793 15.1575 17.6155 14.546 17.1372 14.2698L13 11.8812V6C13 5.44772 12.5523 5 12 5Z" fill="currentColor"></path>
                            </g>
                        </svg>
            ...
            @if (in_array(auth()->user()->role, ['Warehouse']))
                <details {{ request()->routeIs('supply-orders.*') || request()->routeIs('delivery-orders.*') ? 'open' : 'close' }} class="">
                    <summary class="{{ request()->routeIs('supply-orders.*') || request()->routeIs('delivery-orders.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex cursor-pointer items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                        <svg width="28px" height="28px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="#000000" class="{{ request()->routeIs('supply-orders.*') || request()->routeIs('delivery-orders.*') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 transition duration-75 group-hover:text-white">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path fill="currentColor" d="M13.098 8H6.902c-.751 0-1.172.754-.708 1.268L9.292 12.7c.36.399 1.055.399 1.416 0l3.098-3.433C14.27 8.754 13.849 8 13.098 8Z">
                        ...
                        <span class="{{ request()->routeIs('supply-orders.*') || request()->routeIs('delivery-orders.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">
                            Orders</span>
                    </summary>
                    ...
                    <ul class="before:left-4.5 relative flex flex-col items-end space-y-2 pt-2 before:absolute before:bottom-[.75rem] before:start-0 before:top-[.75rem] before:w-1 before:bg-black before:opacity-10 before:content-[''] dark:before:bg-white">
                        {{-- Supply Orders --}}
                        <li class="w-[75%]">
                            <a href="{{ route('supply-orders.index') }}" class="{{ request()->routeIs('supply-orders.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                                <svg class="{{ request()->routeIs('supply-orders.*') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 transition duration-75 group-hover:text-white" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 0.20752L14.625 4.10463V11.8989L7.5 15.796L0.375 11.8989V4.10463L7.5 0.20752ZM5.12496 7.48198L5.125 12.7649L6.70833 13.631V8.34802L5.12496 7.48198ZM1.95833 5.75002V11.0328L3.54165 11.8989V6.61601L1.95833 5.75002ZM10.6169 3.64436L5.95673 6.205L7.5 7.04912L12.1708 4.49435L10.6169 3.64436ZM7.5 1.93957L2.82917 4.49435L4.37521 5.33995L9.03536 2.77934L7.5 1.93957Z" fill="currentColor" />
                                </svg>
                        ...
                        {{-- Delivery Orders --}}
                        <li class="w-[75%]">
                            <a href="{{ route('delivery-orders.index') }}" class="{{ request()->routeIs('delivery-orders.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                                <svg class="{{ request()->routeIs('delivery-orders.*') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 transition duration-75 group-hover:text-white" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            @if (in_array(auth()->user()->role, ['Sales']))
                <details {{ request()->routeIs('sales.request-order.*') || request()->routeIs('sales.custom-penawaran.*') || request()->routeIs('customer.*') ? 'open' : 'close' }} class="">
                    <summary class="{{ request()->routeIs('sales.request-order.*') || request()->routeIs('sales.custom-penawaran.*') || request()->routeIs('customer.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex cursor-pointer items-center rounded-lg p-2 text-base font-medium transition-all duration-200">

                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="{{ request()->routeIs('sales.request-order.*') || request()->routeIs('sales.custom-penawaran.*') || request()->routeIs('customer.*') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 transition duration-75 group-hover:text-white">
                        ...
                        <span class="{{ request()->routeIs('sales.request-order.*') || request()->routeIs('sales.sales-order.*') || request()->routeIs('sales.custom-penawaran.*') || request()->routeIs('customer.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">
                            Sales Module</span>
                    </summary>
                    ...
                    <ul class="before:left-4.5 relative flex flex-col items-end space-y-2 pt-2 before:absolute before:bottom-[.75rem] before:start-0 before:top-[.75rem] before:w-1 before:bg-black before:opacity-10 before:content-[''] dark:before:bg-white">
                        {{-- Request Order --}}
                        <li class="w-[75%]">
                            <a href="{{ route('sales.request-order.index') }}" class="{{ request()->routeIs('sales.request-order.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                                ...
                                <span class="{{ request()->routeIs('sales.request-order.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Penawaran</span>
                            </a>
                        </li>

                        {{-- Custom Penawaran --}}
                        <li class="w-[75%]">
                            <a href="{{ route('sales.custom-penawaran.index') }}" class="{{ request()->routeIs('sales.custom-penawaran.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">



                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="{{ request()->routeIs('sales.custom-penawaran.*') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 transition duration-75 group-hover:text-white">
                        ...
                        {{-- Sales Order --}}
                        <li class="w-[75%]">
                            <a href="{{ route('sales.sales-order.index') }}" class="{{ request()->routeIs('sales.sales-order.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="{{ request()->routeIs('sales.sales-order.*') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 transition duration-75 group-hover:text-white">
                                    <path d="M15 2C8.37256 2 3 7.37256 3 14C3 20.6274 8.37256 26 15 26C21.6274 26 27 20.6274 27 14C27 7.37256 21.6274 2 15 2ZM15 4C20.5228 4 25 8.47715 25 14C25 19.5228 20.5228 24 15 24C9.47715 24 5 19.5228 5 14C5 8.47715 9.47715 4 15 4Z" fill="currentColor" />
            ...
            @if (in_array(auth()->user()->role, ['Supervisor']))
                ...
                <li>
                    <a href="{{ route('supervisor.custom-penawaran.index') }}" class="{{ request()->routeIs('supervisor.custom-penawaran.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">


                        <svg class="{{ request()->routeIs('supervisor.custom-penawaran.*') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 transition duration-75 group-hover:text-white" width="30px" height="30" viewBox="0 0 32 32" enable-background="new 0 0 32 32" id="_x3C_Layer_x3E_" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <g id="clipboard">
                                    <g>
                                        <g>
                                            <g>
                                                <path d="M26.5,3h-5.958v1H26.5C26.776,4,27,4.225,27,4.5v25c0,0.275-0.224,0.5-0.5,0.5h-21 C5.224,30,5,29.775,5,29.5v-25C5,4.225,5.224,4,5.5,4h6V3h-6C4.673,3,4,3.673,4,4.5v25C4,30.327,4.673,31,5.5,31h21 c0.827,0,1.5-0.673,1.5-1.5v-25C28,3.673,27.327,3,26.5,3z" fill="currentColor"></path>
                                            </g>
                                        </g>
                                        <g>
                                            <path d="M25.5,22c-0.276,0-0.5-0.224-0.5-0.5V6h-2.5C22.224,6,22,5.776,22,5.5S22.224,5,22.5,5h3 C25.776,5,26,5.224,26,5.5v16C26,21.776,25.776,22,25.5,22z" fill="currentColor"></path>
                                        </g>
                                        <g>
                                            <path d="M20.5,29h-14C6.224,29,6,28.776,6,28.5v-23C6,5.224,6.224,5,6.5,5h3C9.776,5,10,5.224,10,5.5 S9.776,6,9.5,6H7v22h13.5c0.276,0,0.5,0.224,0.5,0.5S20.776,29,20.5,29z" fill="currentColor"></path>
                                        </g>
                                        <g>
                                            <path d="M20.5,29c-0.064,0-0.129-0.013-0.191-0.038C20.122,28.885,20,28.702,20,28.5v-5 c0-0.276,0.224-0.5,0.5-0.5h5c0.202,0,0.385,0.122,0.462,0.309c0.078,0.187,0.035,0.402-0.108,0.545l-5,5 C20.758,28.949,20.63,29,20.5,29z M21,24v3.293L24.293,24H21z" fill="currentColor"></path>
                                        </g>
                                        <g id="customer_survey_questionnaire_2_">
                                            <g>
                                                <g>
                                                    <path d="M9.653,18.016c-0.004,0-0.007,0-0.011,0c-0.142-0.003-0.276-0.066-0.368-0.174l-1.153-1.346 c-0.18-0.209-0.156-0.525,0.054-0.705c0.21-0.18,0.526-0.154,0.705,0.055l0.791,0.922l1.59-1.693 c0.189-0.201,0.505-0.211,0.707-0.021s0.211,0.506,0.022,0.707l-1.972,2.099C9.923,17.959,9.791,18.016,9.653,18.016z" fill="currentColor"></path>
                                                </g>
                                            </g>
                                            <g>
                                                <g>
                                                    <path d="M9.653,13.016c-0.004,0-0.007,0-0.011,0c-0.142-0.003-0.276-0.066-0.368-0.174l-1.153-1.346 c-0.18-0.209-0.156-0.525,0.054-0.705c0.21-0.18,0.526-0.154,0.705,0.055l0.791,0.922l1.59-1.693 c0.189-0.201,0.505-0.211,0.707-0.021s0.211,0.506,0.022,0.707l-1.972,2.099C9.923,12.959,9.791,13.016,9.653,13.016z" fill="currentColor"></path>
                                                </g>
                                            </g>
                                            <g>
                                                <g>
                                                    <path d="M17.5,23h-4c-0.276,0-0.5-0.224-0.5-0.5s0.224-0.5,0.5-0.5h4c0.276,0,0.5,0.224,0.5,0.5 S17.776,23,17.5,23z" fill="currentColor"></path>
                                                </g>
                                            </g>
                                            <g>
                                                <g>
                                                    <path d="M22.5,21h-9c-0.276,0-0.5-0.224-0.5-0.5s0.224-0.5,0.5-0.5h9c0.276,0,0.5,0.224,0.5,0.5 S22.776,21,22.5,21z" fill="currentColor"></path>
                                                </g>
                                            </g>
                                            <g>
                                                <g>
                                                    <path d="M22.5,16h-3c-0.276,0-0.5-0.224-0.5-0.5s0.224-0.5,0.5-0.5h3c0.276,0,0.5,0.224,0.5,0.5 S22.776,16,22.5,16z" fill="currentColor"></path>
                                                </g>
                                            </g>
                                            <g>
                                                <g>
                                                    <path d="M20.5,18h-7c-0.276,0-0.5-0.224-0.5-0.5s0.224-0.5,0.5-0.5h7c0.276,0,0.5,0.224,0.5,0.5 S20.776,18,20.5,18z" fill="currentColor"></path>
                                                </g>
                                            </g>
                                            <g>
                                                <g>
                                                    <path d="M17.5,16h-4c-0.276,0-0.5-0.224-0.5-0.5s0.224-0.5,0.5-0.5h4c0.276,0,0.5,0.224,0.5,0.5 S17.776,16,17.5,16z" fill="currentColor"></path>
                                                </g>
                                            </g>
                                            <g>
                                                <g>
                                                    <path d="M22.5,11h-9c-0.276,0-0.5-0.224-0.5-0.5s0.224-0.5,0.5-0.5h9c0.276,0,0.5,0.224,0.5,0.5 S22.776,11,22.5,11z" fill="currentColor"></path>
                                                </g>
                                            </g>
                                            <g>
                                                <g>
                                                    <path d="M18.5,13h-5c-0.276,0-0.5-0.224-0.5-0.5s0.224-0.5,0.5-0.5h5c0.276,0,0.5,0.224,0.5,0.5 S18.776,13,18.5,13z" fill="currentColor"></path>
                                                </g>
                                            </g>
                                            <g>
                                                <g>
                                                    <path d="M10.5,23h-2C8.224,23,8,22.776,8,22.5v-2C8,20.224,8.224,20,8.5,20h2c0.276,0,0.5,0.224,0.5,0.5v2 C11,22.776,10.776,23,10.5,23z M9,22h1v-1H9V22z" fill="currentColor"></path>
                                                </g>
                                            </g>
                                        </g>
                                    </g>
                                    <g>
                                        <path d="M20.5,7h-9C11.224,7,11,6.776,11,6.5v-3C11,2.673,11.673,2,12.5,2C12.776,2,13,2.224,13,2.5 S12.776,3,12.5,3C12.224,3,12,3.225,12,3.5V6h8V3.5C20,3.225,19.776,3,19.5,3C19.224,3,19,2.776,19,2.5S19.224,2,19.5,2 C20.327,2,21,2.673,21,3.5v3C21,6.776,20.776,7,20.5,7z" fill="currentColor"></path>
                                    </g>
                                    <g>
                                        <path d="M17.5,3C17.224,3,17,2.776,17,2.5C17,2.225,16.776,2,16.5,2h-1c-0.108,0-0.211,0.033-0.296,0.097 C15.074,2.192,15,2.339,15,2.5C15,2.776,14.776,3,14.5,3S14,2.776,14,2.5c0-0.475,0.228-0.926,0.609-1.207 C14.867,1.102,15.176,1,15.5,1h1C17.327,1,18,1.673,18,2.5C18,2.776,17.776,3,17.5,3z" fill="currentColor"></path>
                                    </g>
                                </g>
                            </g>
                        </svg>

                        <span class="{{ request()->routeIs('supervisor.custom-penawaran.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Approve Custom Penawaran</span>
                    </a>
                </li>
            @endif
            ...
            @if (in_array(auth()->user()->role, ['Supervisor']))
                ...
                <li>
                    <a href="{{ route('admin.sent_penawaran') }}" class="{{ request()->is('sent-penawaran') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                        <svg fill="currentColor" height="30px" width="30px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 491.695 491.695" xml:space="preserve" class="{{ request()->is('sent-penawaran') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 group-hover:text-white">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <g>
                                    ...
                                    <path d="M359.246,158.869h34.87c5.799,0,10.5-4.701,10.5-10.5c0-5.799-4.701-10.5-10.5-10.5h-34.87c-5.799,0-10.5,4.701-10.5,10.5 C348.746,154.168,353.447,158.869,359.246,158.869z"></path>
                                    <path d="M359.246,233.11h34.87c5.799,0,10.5-4.701,10.5-10.5c0-5.799-4.701-10.5-10.5-10.5h-34.87c-5.799,0-10.5,4.701-10.5,10.5 C348.746,228.409,353.447,233.11,359.246,233.11z"></path>
                                    <path d="M359.246,307.352h34.87c5.799,0,10.5-4.701,10.5-10.5s-4.701-10.5-10.5-10.5h-34.87c-5.799,0-10.5,4.701-10.5,10.5 S353.447,307.352,359.246,307.352z"></path>
                                    <path d="M394.116,381.593c5.799,0,10.5-4.701,10.5-10.5s-4.701-10.5-10.5-10.5h-98.225c-5.799,0-10.5,4.701-10.5,10.5 s4.701,10.5,10.5,10.5H394.116z"></path>
                                    <path d="M236.982,168.845l-12.81-12.81c-3.45-3.449-8.036-5.349-12.915-5.349s-9.465,1.9-12.915,5.349l-67.19,67.19l-18.573-18.573 c-3.449-3.448-8.036-5.348-12.914-5.348c-4.878,0-9.465,1.9-12.914,5.349l-12.813,12.812c-7.12,7.121-7.12,18.708,0.001,25.829 l44.297,44.296c3.45,3.451,8.037,5.351,12.916,5.351c0,0,0.001,0,0.001,0c4.878,0,9.465-1.9,12.913-5.349l92.917-92.917 C244.103,187.554,244.103,175.966,236.982,168.845z M131.151,270.807l-40.429-40.428l8.942-8.942l24.062,24.062 c4.101,4.101,10.749,4.101,14.85,0l72.681-72.681l8.942,8.942L131.151,270.807z"></path>
                                </g>
                            </g>
                        </svg>
                        <span class="{{ request()->is('sent-penawaran') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Sent
                            Penawaran</span>
                    </a>
                </li>
                ...
                {{-- History Orders --}}
                <li>
                    <a href="{{ route('orders.history') }}" class="{{ request()->routeIs('admin.orders.history') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                        <svg aria-hidden="true" class="{{ request()->routeIs('admin.orders.history') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 transition duration-75 group-hover:text-white" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M5 4h10v2H5V4zM5 8h10v2H5V8zM5 12h6v2H5v-2z"></path>
                        </svg>
                        <span class="{{ request()->routeIs('admin.orders.history') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">History
                            Orders</span>
                    </a>
                </li>
        </ul>
