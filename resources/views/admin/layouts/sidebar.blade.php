<!-- Sidebar -->
<aside class="lg:relative mt-22 lg:mt-0 w-64 lg:w-full fixed left-0 top-0 z-40 h-full -translate-x-full rounded-xl transition-transform dark:bg-[#0B1D31] lg:translate-x-0" aria-label="Sidenav" id="drawer-navigation">
    <div class="h-full overflow-y-auto rounded-xl bg-gradient-to-r from-[#225A97] to-[#1F5188] px-3 py-5 dark:bg-gradient-to-r dark:from-[#0B1D31] dark:to-[#0E243D]">
                    ...
                    <ul
                        ...
                        <li class="w-[179px]">
                            <a href="{{ route('delivery-orders.index') }}"
                                ...
                                <svg class="{{ request()->routeIs('delivery-orders.*') ? 'text-black dark:text-white' : 'text-white' }} h-6 w-6 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white"
