            ...
            @if (in_array(auth()->user()->role, ['General Affair']))
                ...
                <li>
                    <a href="{{ route('goods-in-status.index') }}"
                        ...
                        <span
                            class="{{ request()->routeIs('goods-in-status.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Manajemen
                            Entitas</span>
                    </a>
                </li>
                {{-- Akun Sales --}}
            ...
            @if (in_array(auth()->user()->role, ['Sales']))
                <li>
                    <a href="{{ route('requestorder.create') }}"
                        ...
                        <svg aria-hidden="true"
                            class="{{ request()->routeIs('requestorder.*') ? 'text-white' : 'text-blue-500 dark:text-white' }} h-6 w-6 group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M3 10a1 1 0 011-1h2V7a1 1 0 112 0v2h2a1 1 0 110 2h-2v2a1 1 0 11-2 0v-2H4a1 1 0 01-1-1z" />
                        </svg>
                        <span
                            class="{{ request()->routeIs('requestorder.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Request
                            Order</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('sales.order') }}"
                        ...
                        <svg aria-hidden="true"
                            class="{{ request()->routeIs('sales.order') ? 'text-white' : 'text-green-500 dark:text-white' }} h-6 w-6 group-hover:text-white"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path d="M3 3h14v2H3V3zm0 4h14v10H3V7z"></path>
                        </svg>
                        <span
                            class="{{ request()->routeIs('sales.order') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Sales
                            Order</span>
                    </a>
                </li>
            @endif
