    ...
    <div class="h-full overflow-y-auto rounded-xl bg-white px-3 py-5 dark:bg-[#0D223A]">
        ...
        <ul class="space-y-2">
                    ...
                    <ul>
                        @if (request()->routeIs('add-stock.*'))
                            <li class="flex items-center justify-end">
                                <svg width="64px" class="h-6 w-6 text-black transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white" height="64px" viewBox="0 0 24 24"
            ...
            @if (in_array(auth()->user()->role, ['Sales']))
                <details {{ request()->routeIs('sales.request-order.*') || request()->routeIs('sales.sales-order.*') || request()->routeIs('sales.custom-penawaran.*') ? 'open' : 'close' }} class="">
                    <summary
                        class="{{ request()->routeIs('sales.request-order.*') || request()->routeIs('sales.sales-order.*') || request()->routeIs('sales.custom-penawaran.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex cursor-pointer items-center rounded-lg p-2 text-base font-medium transition-all duration-200">

                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"
                            class="{{ request()->routeIs('sales.request-order.*') || request()->routeIs('sales.sales-order.*') || request()->routeIs('sales.custom-penawaran.*') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 transition duration-75 group-hover:text-white">
                    ...
                    <ul
                        ...
                        <li class="w-[75%]">
                            <a href="{{ route('sales.custom-penawaran.index') }}"
                                ...
                                <span class="{{ request()->routeIs('sales.custom-penawaran.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Penawaran Kustom</span>
                            </a>
                        </li>
            ...
            @if (in_array(auth()->user()->role, ['Supervisor']))
                ...
                <li>
                    <a href="{{ url('/incoming') }}"
                        ...
                        <span class="{{ request()->is('incoming') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Incoming
                            Orders</span>
                    </a>
                </li>
                {{-- Approved Orders --}}
                <li>
                    <a href="{{ route('admin.approved') }}"
                        ...
                        <span class="{{ request()->is('approved-orders') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Approved
                            Orders</span>
                    </a>
                </li>
