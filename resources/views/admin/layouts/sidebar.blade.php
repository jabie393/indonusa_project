            ...
            @if (in_array(auth()->user()->role, ['Sales']))
                <details {{ request()->routeIs('sales.request-order.*') || request()->routeIs('sales.sales-order.*') ? 'open' : 'close' }} class="">
                    <summary
                        ...
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"
                            class="{{ request()->routeIs('sales.request-order.*') || request()->routeIs('sales.sales-order.*') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 transition duration-75 group-hover:text-white">
                        ...
                        <span
                            class="{{ request()->routeIs('sales.request-order.*') || request()->routeIs('sales.sales-order.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">
                            Sales Module</span>
                    </summary>
