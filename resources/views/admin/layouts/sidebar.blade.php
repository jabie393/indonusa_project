            ...
            @if (in_array(auth()->user()->role, ['admin_warehouse']))
                ...
                <li>
                    <a href="{{ route('delivery-orders.index') }}"
                        ...
                        <span
                            class="{{ request()->routeIs('delivery-orders.*') ? 'text-black dark:text-white' : 'text-white' }} ml-3 group-hover:text-black">Delivery
                            Orders</span>
                    </a>
                </li>
            @endif
            ...
            @if (in_array(auth()->user()->role, ['admin_PT']))
                        ...
                        <li>
                            <a href="{{ url('/incoming') }}"
                                ...
                                <span
                                    class="{{ request()->routeIs('orders.incoming') ? 'text-black dark:text-white' : 'text-white' }} ml-3 group-hover:text-black dark:group-hover:text-white">Incoming
                                    Orders</span>
                            </a>
                        </li>
