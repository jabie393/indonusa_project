            ...
            @if (in_array(auth()->user()->role, ['admin_supply']))
                ...
                <li>
                    <a href="{{ route('goods-in.index') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none" class="{{ request()->routeIs('goods-in.*') ? 'text-black dark:text-white' : 'text-white' }} group-hover:text-black dark:group-hover:text-white">
                ...
                <li>
                    <a href="{{ route('goods-in-status.index') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="29" viewBox="0 0 28 29" fill="none">
                            <path d="M8.20312 13.0952H19.8187V14.4546H8.20312V13.0952ZM8.20312 19.0765H15.3125V20.4358H8.20312V19.0765Z" fill="currentColor"  class="{{ request()->routeIs('goods-in-status.*') ? 'text-black dark:text-white' : 'text-white dark:text-black' }} group-hover:text-black dark:text-white dark:group-hover:text-white"/>
                            <path
                ...
                <li>
                    <a href="{{ route('history.index') }}"
                        ...
                        <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="{{ request()->routeIs('history.*') ? 'text-black dark:text-white' : 'text-white dark:text-black' }} group-hover:text-black dark:text-white dark:group-hover:text-white">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path
            ...
            @if (in_array(auth()->user()->role, ['admin_PT']))
                ...
                <li>
                    <a href="{{ route('orders.incoming') }}"
                        ...
                        <span class="{{ request()->routeIs('orders.incoming') ? 'text-black dark:text-white' : 'text-white' }} ml-3 group-hover:text-black dark:group-hover:text-white">Incoming
                            Orders</span>
                    </a>
                </li>
