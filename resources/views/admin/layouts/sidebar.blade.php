            ...
            @if (in_array(auth()->user()->role, ['General Affair']))
                ...
                <li>
                    <a href="{{ route('goods-in.index') }}"
                        ...
                        <span class="{{ request()->routeIs('goods-in.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Goods In</span>
                    </a>
                    {{-- Add Stock --}}
                    <ul>
                ...
                <li>
                    <a href="{{ route('goods-in-status.index') }}"
                        ...
                        <span class="{{ request()->routeIs('goods-in-status.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Goods In Status</span>
                    </a>
                </li>
                {{-- History --}}
                <li>
            ...
            @if (in_array(auth()->user()->role, ['Sales']))
                <li>
                    <a href="{{ route('requestorder.create') }}"
                        ...
                        <span class="{{ request()->routeIs('requestorder.*') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Request Order</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('sales.order') }}"
                        ...
                        <span class="{{ request()->routeIs('sales.order') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Sales Order</span>
                    </a>
                </li>
            @endif
            ...
            @if (in_array(auth()->user()->role, ['Supervisor']))
                ...
                <li>
                    <a href="{{ url('/incoming') }}"
                        ...
                        <span class="{{ request()->is('incoming') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Incoming Orders</span>
                    </a>
                </li>
                {{-- Approved Orders --}}
                <li>
                    <a href="{{ route('admin.approved') }}"
                        ...
                        <span class="{{ request()->is('approved-orders') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">Approved Orders</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('orders.history') }}"
                        ...
                        <span class="{{ request()->routeIs('admin.orders.history') ? 'text-white' : 'text-black dark:text-white' }} ml-3 group-hover:text-white">History Orders</span>
                    </a>
                </li>
        </ul>
    </div>
