...
<aside
    ...
    <div
        class="inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm h-full flex flex-col justify-between overflow-y-auto rounded-xl bg-white p-3 dark:bg-[#0D223A]">
        ...
        <ul class="space-y-2">
            ...
            <li>
                <a href="{{ route('dashboard') }}"
                    ...
                    <span
                        class="{{ request()->routeIs('dashboard') ? 'text-white' : 'text-black dark:text-white' }} ml-2 group-hover:text-white">Dashboard</span>
                </a>
            </li>
            ...
            @if (in_array(auth()->user()->role, ['General Affair']))
                ...
                @php
                    ...
                    $goodsInProcurementRevisionCount = \App\Models\ProcurementOfGoods::whereNotIn('status', ['completed', 'canceled'])->count();
                ...
                <li>
                    ...
                    @endif
                    @if (request()->routeIs('general-affair.procurement.*'))
                        <ul class="pt-2">
                            <li class="flex items-center justify-end">
                                <svg width="64px"
                                    class="h-6 w-6 text-black transition duration-75 group-hover:text-gray-900 dark:text-gray-100 dark:group-hover:text-white"
                ...
                <li>
                    <a href="{{ route('goods-in-status.index') }}"
                        ...
                        <span
                            class="{{ request()->routeIs('goods-in-status.*') ? 'text-white' : 'text-black dark:text-white' }} ml-2 group-hover:text-white">Goods
                            In Status</span>
                    </a>
                </li>
                    ...
                    <ul
                        ...
                        <li class="w-[88%]">
                            <a href="{{ route('sales-agents.index') }}"
                                ...
                                <span
                                    class="{{ request()->routeIs('sales-agents.*') ? 'text-white' : 'text-black dark:text-white' }} ml-2 group-hover:text-white">Sales
                                    Agents
                                </span>
                            </a>
                        </li>
                        ...
                        <li class="w-[88%]">
                            <a href="{{ route('customers.index') }}"
                                ...
                                <span
                                    class="{{ request()->routeIs('customers.*') ? 'text-white' : 'text-black dark:text-white' }} ml-2 group-hover:text-white">Customers</span>
                            </a>
                        </li>
            ...
            @php
                $sidebarSupplyOrderCount = \App\Models\Goods::where('goods_status', 'pending')
                    ...
                    ->count()
                    + \App\Models\ProcurementArrivalRequest::whereIn('status', ['pending_warehouse', 'pending'])->count();
            ...
            @if (auth()->user()->role === 'General Affair')
                ...
                <li>
                    <a href="{{ route('catalog.index') }}"
                        ...
                        <span
                            class="{{ request()->routeIs('catalog.*') ? 'text-white' : 'text-black dark:text-white' }} ml-2 group-hover:text-white">Catalog</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('sales-report.index') }}"
                        ...
                        <span
                            class="{{ request()->routeIs('sales-report.*') ? 'text-white' : 'text-black dark:text-white' }} ml-2 group-hover:text-white">Sales
                            Report</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('history.index') }}"
                        ...
                        <span
                            class="{{ request()->routeIs('history.*') ? 'text-white' : 'text-black dark:text-white' }} ml-2 group-hover:text-white">History</span>
                    </a>
                </li>
            @endif
            ...
            @if (in_array(auth()->user()->role, ['Sales']))
                ...
                @endphp
                <details {{ request()->routeIs('sales.quotation.*') || request()->routeIs('sales.custom-quotation.*') ? 'open' : 'close' }}
                    class="">
                    <summary
                        ...
                        <span class="flex items-center">
                            ...
                            <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="{{ request()->routeIs('sales.quotation.*') || request()->routeIs('sales.custom-quotation.*') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 shrink-0 transition duration-75 group-hover:text-white">
                            ...
                            <span
                                class="{{ request()->routeIs('sales.quotation.*') || request()->routeIs('sales.custom-quotation.*') ? 'text-white' : 'text-black dark:text-white' }} ml-2 group-hover:text-white">
                                        ...
                                        <a href="{{ request()->fullUrl() }}"
                                            ...
                                            <span class="">
                                                @if (request()->routeIs('sales.quotation.show'))
                                                    Detail Quotation
                                                @elseif (request()->routeIs('sales.quotation.create') || request()->routeIs('sales.quotation.store'))
                                                    Create Quotation
                                                @elseif (request()->routeIs('sales.quotation.edit') || request()->routeIs('sales.quotation.update'))
                                                    Edit Quotation
                                                @endif
                                            </span>
                                        </a>
                        ...
                        <li class="w-[88%]">
                            <a href="{{ route('sales.custom-quotation.index') }}"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="{{ request()->routeIs('sales.custom-quotation.index') ? 'text-white' : 'text-black dark:text-white' }} ml-2 group-hover:text-white">Non-Listing</span>
                                </div>
                                        ...
                                        <a href="{{ request()->fullUrl() }}"
                                            ...
                                            <span class="">
                                                @if (request()->routeIs('sales.custom-quotation.show'))
                                                    Detail Quotation
                                                @elseif (request()->routeIs('sales.custom-quotation.create') || request()->routeIs('sales.custom-quotation.store'))
                                                    Create Quotation
                                                @elseif (request()->routeIs('sales.custom-quotation.edit') || request()->routeIs('sales.custom-quotation.update'))
                                                    Edit Quotation
                                                @endif
                                            </span>
                                        </a>
                ...
                <li>
                    <a href="{{ route('sales.sales-orders.index') }}"
                        class="{{ request()->routeIs('sales.sales-orders.*') ? 'bg-gradient-to-r from-[#225A97] to-[#0D223A] text-white inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm' : 'bg-white text-black hover:bg-gradient-to-r hover:from-[#225A97] hover:to-[#0D223A] hover:text-white dark:bg-[#0D223A] dark:text-white dark:hover:bg-gradient-to-r dark:hover:from-[#225A97] dark:hover:to-[#0D223A]' }} group flex items-center rounded-lg p-2 text-base font-medium transition-all duration-200">
                        <svg viewBox="0 0 30 30" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                            class="{{ request()->routeIs('sales.sales-orders.*') ? 'text-white' : 'text-black dark:text-white' }} h-6 w-6 shrink-0 transition duration-75 group-hover:text-white">
                            <path
                        ...
                        <span
                            class="{{ request()->routeIs('sales.sales-orders.*') ? 'text-white' : 'text-black dark:text-white' }} ml-2 group-hover:text-white">Sales
                            Orders</span>
                    </a>
            ...
            @if (in_array(auth()->user()->role, ['Supervisor']))
                        ...
                        <li class="w-[88%]">
                            <a href="{{ route('admin.quotation_approval') }}"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="{{ $quotationApprovalItemHighlight ? 'text-white' : 'text-black dark:text-white' }} ml-2 group-hover:text-white">Listing</span>
                                </div>
                ...
                <li>
                    <a href="{{ route('supervisor.history') }}"
                        ...
                        <span class="ml-2 group-hover:text-white">Quotation History</span>
                    </a>
                </li>
        ...
        <button onclick="guide.showModal()"
            ...
            <span class="ml-2 group-hover:text-white">Manual Guide</span>
        </button>
    </div>
</aside>