            ...
            <div class="grid grid-cols-5 gap-4">
                ...
                <div class="relative overflow-auto flex-1 min-h-0 text-black dark:text-gray-200 col-span-3">
                    <div id="edit_brand_container" class="form-control relative w-full px-2" x-data="{
                        ...
                        <div class="relative">
                            <input type="text" id="edit_brand_name" name="brand_name" x-model="search" @click="open = true" @click.away="open = false" @keydown.escape="open = false" @keydown.enter.prevent="open = false" placeholder="Pilih atau ketik brand baru..." class="input input-bordered focus:input-primary w-full pr-10 transition-all" autocomplete="off" required>
