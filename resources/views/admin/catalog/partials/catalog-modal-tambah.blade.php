        ...
        <form action="{{ route('catalog.store') }}" method="POST" enctype="multipart/form-data" class="relative h-full flex-col gap-4 overflow-hidden p-4">
            ...
            <div class="grid grid-cols-5 gap-4">
                ...
                <div class="relative h-full overflow-auto text-black dark:text-gray-200 col-span-3 ">
                    ...
                    <div class="mb-4 px-2">
                        <label for="catalog_name" class="mb-2 block text-sm font-medium">Nama Katalog</label>
                        <input type="text" id="catalog_name" name="catalog_name" placeholder="Nama Katalog" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm focus:border-primary-600 focus:ring-primary-600 dark:border-gray-500 dark:bg-gray-600 dark:placeholder-gray-400" required>
                    </div>
                    <div class="mb-4 px-2">
                        ...
                        <input type="hidden" name="catalog_file_path" id="catalog_file_path">
...
<script>
    document.getElementById('catalog_file').addEventListener('change', function(event) {
        ...
        const progressPercent = document.getElementById('upload_percentage');
        ...
        xhr.onload = function() {
            if (xhr.status === 200) {
                ...
                document.getElementById('catalog_file_path').value = response.path;
    ...
    document.getElementById('createCatalogModal').addEventListener('close', function() {
        ...
        document.getElementById('catalog_file_path').value = '';
