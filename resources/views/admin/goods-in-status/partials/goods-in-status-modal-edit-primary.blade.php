            ...
            <div class="space-y-5">
                ...
                <div class="space-y-2">
                    ...
                    <input
                        ...
                        id="edit_goods_name" name="goods_name" type="text" placeholder="cth. Kopi Arabika 250g" required />
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <textarea
                        ...
                        id="edit_deskripsi" name="deskripsi" rows="3" placeholder="Tulis deskripsi singkat tentang barang (opsional)…"></textarea>
                </div>
