                    ...
                    <div class="relative overflow-hidden rounded-2xl bg-slate-900 p-6 text-white shadow-lg">
                        ...
                        <div class="relative z-10 space-y-4">
                            ...
                            <form id="tambahStockForm" method="POST" class="grid gap-4 sm:grid-cols-2">
                                ...
                                <div class="space-y-2">
                                    <label for="edit_stock_new_stock"
                                        class="text-xs font-semibold text-slate-300">Request Stok Baru</label>
                                ...
                                <div class="space-y-2">
                                    <label for="edit_buy_price_input_new_stock_display"
                                        class="text-xs font-semibold text-slate-300">Harga Beli Baru</label>
                                    <div class="relative">
                                        <span
