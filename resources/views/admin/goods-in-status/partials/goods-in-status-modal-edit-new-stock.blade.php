                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="min-h-[60px] text-sm leading-relaxed text-slate-600 italic" id="edit_description_new_stock">-</div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div class="rounded-2xl border border-slate-100 bg-slate-50/50 p-4">
                                ...
                                <p class="text-sm font-mono font-bold text-slate-800" id="edit_goods_code_new_stock">-</p>
                            </div>
                            <div class="rounded-2xl border border-slate-100 bg-slate-50/50 p-4">
                    ...
                    <div class="relative overflow-hidden rounded-2xl bg-slate-900 p-6 text-white shadow-lg">
                        ...
                        <div class="relative z-10 space-y-4">
                            ...
                            <form id="tambahStockForm" method="POST" class="grid gap-4 sm:grid-cols-2">
                                ...
                                <div class="space-y-2">
                                    <label for="edit_stock_new_stock" class="text-xs font-semibold text-slate-300">Request Stok Baru</label>
                                ...
                                <div class="space-y-2">
                                    <label for="edit_buy_price_input_new_stock_display" class="text-xs font-semibold text-slate-300">Harga Beli Baru</label>
                                    <div class="relative">
