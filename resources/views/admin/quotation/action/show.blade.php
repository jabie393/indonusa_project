                            ...
                            <table class="w-full text-left text-sm">
                                ...
                                <tfoot class="bg-gray-50/50 dark:bg-gray-700/30">
                                    <tr class="border-t border-gray-100 dark:border-gray-700">
                                        <td colspan="4"
                                            class="px-6 py-4 text-right text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Total Keseluruhan</td>
                            ...
                            <div class="p-6">
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="mb-4 space-y-3 border-b border-gray-100 pb-4 dark:border-gray-700">
                                        ...
                                        <div class="grid grid-cols-2 gap-3">
                                            <form action="{{ route('supervisor.quotation.approve', $requestOrder->id) }}"
                                                ...
                                                @csrf
                                                <button type="submit"
                                                    class="flex w-full items-center justify-center space-x-2 rounded-xl bg-emerald-600 py-2.5 text-xs font-bold text-white shadow-lg shadow-emerald-200 transition-all hover:bg-emerald-700 hover:shadow-none dark:shadow-none">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="h-4 w-4"
                                                        fill="none"
                                                        viewBox="0 0 24 24"
                                            ...
                                            <button onclick="openTolakModal('request_order', '{{ $requestOrder->id }}', '{{ $requestOrder->request_number }}')"
                                                title="Tolak"
                                                class="flex w-full items-center justify-center space-x-2 rounded-xl bg-rose-600 py-2.5 text-xs font-bold text-white shadow-lg shadow-rose-200 transition-all hover:bg-rose-700 hover:shadow-none dark:shadow-none">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="h-4 w-4"
                                                    fill="none"
                                                    viewBox="0 0 24 24"
                                    ...
                                    <div class="grid grid-cols-2 gap-3">
                                        ...
                                        {{-- PDF Button (Enabled) --}}
                                        <a href="{{ route($pdfRoute, $requestOrder->id) }}"
                                            target="_blank"
                                            class="flex items-center justify-center space-x-2 rounded-xl bg-[#10B981] py-2.5 text-xs font-bold text-white shadow-lg shadow-emerald-200 transition-all hover:bg-emerald-600 hover:shadow-none dark:shadow-none">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-4 w-4"
                                                fill="none"
                                                viewBox="0 0 24 24"
                                    ...
                                    <form action="{{ route('sales.quotation.sent-to-warehouse', $requestOrder->id) }}"
                                        ...
                                        @csrf
                                        <button type="submit"
                                            class="flex w-full items-center justify-center space-x-3 rounded-xl bg-[#225A97] py-3 text-sm font-black text-white shadow-xl shadow-blue-200 transition-all hover:bg-[#1a4675] hover:shadow-none active:scale-[0.98] dark:shadow-none">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-5 w-5"
                                                fill="none"
                                                viewBox="0 0 24 24"
                ...
                <div class="modal-content">
                    ...
                    <form method="GET"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="pdf_note"
                                    class="form-label">Catatan yang akan muncul di PDF</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit"
                                class="btn btn-primary">Generate &amp; Download PDF</button>
                        </div>
                    </form>
                </div>
            </div>
