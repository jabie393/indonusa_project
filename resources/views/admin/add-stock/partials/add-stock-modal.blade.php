                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-5">
                        <div class="space-y-2">
                            ...
                            <div class="text-lg font-bold text-slate-800" id="nama_barang">-</div>
                        </div>

                        <div class="space-y-2">
                            <label class="text-xs font-bold uppercase tracking-wider text-slate-400">Deskripsi</label>
                            <div class="min-h-[60px] text-sm leading-relaxed text-slate-600 italic" id="deskripsi">-</div>
                        </div>
                    ...
                    <div class="relative overflow-hidden rounded-2xl bg-slate-900 p-6 text-white shadow-lg">
                        ...
                        <div class="relative z-10 space-y-4">
                            ...
                            <form id="tambahStockForm" method="POST" class="grid gap-4 sm:grid-cols-2">
                                ...
                                <div class="space-y-2">
                                    <label for="stok" class="text-xs font-semibold text-slate-300">Stok Baru</label>
                                ...
                                <div class="space-y-2">
                                    <label for="unit_cost_display" class="text-xs font-semibold text-slate-300">Harga Beli Baru</label>
                                    <div class="relative">
