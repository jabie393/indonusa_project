<x-app-layout>
    <div class="inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm relative mb-5 flex justify-end overflow-hidden rounded-2xl bg-white shadow-md dark:bg-gray-800">
        <div class="p-4">
            {{-- Search --}}
            <form action="{{ route('goods-receipts.index') }}"
                  method="GET"
                  class="block pl-2">
            ...
            <table id="DataTable"
                ...
                <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col"
                            class="px-4 py-3">Stok Saat Ini</th>
                        <th scope="col"
                ...
                <tbody class="h-min-[300px]">
                    @forelse ($goods as $barang)
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td scope="row"
                                class="whitespace-nowrap px-4 font-medium text-gray-900 dark:text-white">
                                {{ $barang->kode_barang }}
                            </td>
                            ...
                            <td class="w-fit px-4 py-3 text-right">
                                <button class="view-history-btn group flex cursor-pointer items-center justify-center rounded-lg bg-blue-700 p-2 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                        data-id="{{ $barang->id }}"
                                    ...
                                    <span class="max-w-0 overflow-hidden text-nowrap opacity-0 transition-all duration-300 ease-in-out group-hover:max-w-xs group-hover:pl-2 group-hover:opacity-100">Riwayat
                                        Harga</span>
                                </button>
                            </td>
                        </tr>
