...
<html lang="id-ID">
    ...
    <body class="m-0 flex justify-center bg-slate-200 p-0 print:bg-white">
        ...
        <div class="relative h-[29.7cm] w-full max-w-[21cm] overflow-hidden bg-white shadow-md print:m-0 print:h-[29.7cm] print:w-[21cm] print:shadow-none">
            ...
            <div class="relative h-full w-full p-[1.27cm] text-[11pt] leading-[1.08]" style="font-family: 'Tinos', serif;">
                ...
                <div class="mt-5 text-[9pt]">
                    <table class="w-full border-collapse">
                        <tbody>
                            <tr>
                                <td class="w-[320pt] px-2 py-1.5 align-top text-black">Delivery To :</td>
                                <td class="w-[60pt] px-2 py-1.5 align-top text-black">Date</td>
                                <td class="w-[140pt] px-2 py-1.5 align-top text-black">: {{ $orders->created_at->format('d F Y') }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-1.5 align-top text-black">PO No</td>
                                <td class="px-2 py-1.5 align-top text-black">: {{ $orders->requestOrder?->no_po ?? '-' }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
