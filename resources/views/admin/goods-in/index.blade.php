<x-app-layout>
    <div
        class="relative h-full overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm">
        <div
            class="flex flex-col items-center justify-between space-y-3 bg-gradient-to-r from-[#225A97] to-[#0D223A] p-4 md:flex-row md:space-x-4 md:space-y-0 inset-shadow-none dark:inset-shadow-gray-500 dark:inset-shadow-sm">
        </div>
                ...
                <button onclick="tambahBarang.showModal()"
                    ...
                    <div class="relative z-10 flex flex-col items-center gap-4">
                        ...
                        <div class="flex flex-col items-center gap-1 text-center">
                            ...
                            <span
                                class="text-xs text-gray-600 transition-colors duration-300 group-hover:text-white/70 dark:text-gray-400">Input
                ...
                <a href="{{ route('add-stock.index') }}"
                    ...
                    <div class="relative z-10 flex flex-col items-center gap-4">
                        ...
                        <div class="flex flex-col items-center gap-1 text-center">
                            ...
                            <span
                                class="text-xs text-gray-600 transition-colors duration-300 group-hover:text-white/70 dark:text-gray-400">Update
                ...
                <button onclick="ExcelImportOptionModal.showModal()"
                    ...
                    <div class="relative z-10 flex flex-col items-center gap-4">
                        <div
                            ...
                            <svg width="40" height="40" viewBox="0 0 62 62" fill="none"
                                ...
                                <g clip-path="url(#clip0_1070_27)">
                                    ...
                                    <path d="M40.0417 19.375H43.9167" stroke="currentColor" stroke-width="4"
                                        stroke-linecap="round" />
                                    <path d="M36.1667 29.708H43.9167" stroke="currentColor" stroke-width="4"
                                        stroke-linecap="round" />
                                    <path d="M36.1667 40.0415H43.9167" stroke="currentColor" stroke-width="4"
                                        stroke-linecap="round" />
                                    <path d="M28.4167 19.375H5.16669V42.625H28.4167V19.375Z" fill="currentColor"
                                        stroke="currentColor" stroke-width="4" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M12.9167 27.125L20.6667 34.875"
                                        class="stroke-white transition-colors duration-300 group-hover:stroke-black"
                                        stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M20.6667 27.125L12.9167 34.875"
                                        class="stroke-white transition-colors duration-300 group-hover:stroke-black"
                                        stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                    <mask id="path-8-outside-1_1070_27" maskUnits="userSpaceOnUse" x="41" y="44"
                                        width="19" height="19" fill="black">
                                        <rect fill="currentColor" x="41" y="44" width="19" height="19" />
                                        <path
                                            d="M58.07 55.81H52.85V61.15H47.99V55.81H42.77V51.22H47.99V45.85H52.85V51.22H58.07V55.81Z" />
                                    </mask>
                                    <path
                                        d="M58.07 55.81H52.85V61.15H47.99V55.81H42.77V51.22H47.99V45.85H52.85V51.22H58.07V55.81Z"
                                        fill="black" />
                        ...
                        <div class="flex flex-col items-center gap-1 text-center">
                            ...
                            <span
                                class="text-xs text-gray-600 transition-colors duration-300 group-hover:text-white/70 dark:text-gray-400">Import
    ...
    <!-- Modals -->
    @include('admin.goods-in.partials.goods-in-modal-add', ['kategoriList' => $kategoriList])
