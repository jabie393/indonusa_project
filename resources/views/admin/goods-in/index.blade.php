                        ...
                        <div
                            ...
                            <svg width="40" height="40" viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_1070_27)">
                                    ...
                                    <path d="M28.4167 19.375H5.16669V42.625H28.4167V19.375Z" fill="currentColor" stroke="currentColor" stroke-width="4" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M12.9167 27.125L20.6667 34.875" class="stroke-white transition-colors duration-300 group-hover:stroke-black" stroke-width="4" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M20.6667 27.125L12.9167 34.875" class="stroke-white transition-colors duration-300 group-hover:stroke-black" stroke-width="4" stroke-linecap="round"
                                        stroke-linejoin="round" />
