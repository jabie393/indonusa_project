<footer class="w-full bg-black ">
                ...
                <div class="flex-center mb-6 flex md:mb-0">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <a class="mt-3 flex font-semibold text-white"
                               href="tel:+628133317191">
                                <svg class="h-6 w-6 pr-1"
                                     viewBox="0 0 24 24"
                                     fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a class="mb-6 mt-3 flex font-semibold text-white"
    ...
    <div class="my-6 w-full sm:flex sm:items-center sm:justify-between max-w-(--breakpoint-2xl) mx-auto">
        <div class="text-sm text-gray-500 dark:text-gray-400 sm:text-center">© 2026 <a href="#"
        ...
        <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 sm:text-center">
            Created By <a href="https://ryu.dev" target="_blank"
                class="hover:underline">
                Ryu.dev</a>
        </div>
    </div>
