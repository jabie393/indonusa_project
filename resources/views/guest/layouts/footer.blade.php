<footer class="w-full bg-black ">
            ...
            <div class="md:flex md:justify-between">
                <div class="flex-center mb-6 flex md:mb-0">
                    ...
                    <div>
                        ...
                        <div>
                            <a class="mt-6 flex font-semibold text-white"
                            ...
                            <a class="mt-3 flex font-semibold text-white" href="tel:+628133317191">
                                <svg class="h-6 w-6 pr-1" viewBox="0 0 24 24" fill="none"
                            ...
                            <a class="mb-6 mt-3 flex font-semibold text-white" href="mailto:infoindousajaya@gmail.com">
                ...
                <div class="grid grid-rows-2 sm:grid-rows-3 sm:gap-1">
                    <h2 class="flex items-center justify-center font-semibold text-white">
                        FOLLOW US
                    </h2>
                    <div class="mt-4 flex justify-end space-x-6 sm:mt-0">
                        <a href="https://www.tokopedia.com/ijb-teknik-solution" target="_blank"
                            rel="noopener noreferrer" class="text-gray-500 hover:text-white dark:hover:text-white">
                        ...
                        <a href="https://www.instagram.com/indonusajayabersama" target="_blank"
                            rel="noopener noreferrer" class="text-gray-500 hover:text-white dark:hover:text-white">
    ...
    <hr class="border-gray-600 dark:border-gray-700 sm:mx-auto max-w-(--breakpoint-2xl)" />
    <div class="my-6 w-full sm:flex sm:items-center sm:justify-between max-w-(--breakpoint-2xl) mx-auto">
