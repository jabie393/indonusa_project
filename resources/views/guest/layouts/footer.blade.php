<footer class="w-full">
            ...
            <div class="md:flex md:justify-between">
                <div class="flex-center mb-6 flex md:mb-0">
                    <a href="/" class="flex items-start">
                        <x-application-logo class="mr-3 h-12" />
                    </a>
                    <div>
                        ...
                        <div>
                            <a class="mt-6 flex font-semibold text-white" href="https://maps.app.goo.gl/PupLG3krcusGxYT29">
                                ...
                                <span class="pl-1">
                                    Jl.Wonorejo Selatan Gg 5b Kav.50 Kel
                                    <br>
                                    Wonorejo, Kec Rungkut Surabaya
                                </span>
                            </a>
                            <a class="flex font-semibold text-white" href="tel:+628133317191">
                            ...
                            <a class="mb-6 flex font-semibold text-white" href="mailto:infoindousajaya@gmail.com">
                                <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
                                ...
                                <span class="pl-1">
                                    infoindousajaya@gmail.com
                                </span>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="grid grid-rows-2 sm:grid-rows-3 sm:gap-1">
                    <h1 class="flex items-center justify-center font-semibold text-white">
                        FOLLOW US
                    </h1>
                    <div class="mt-4 flex justify-end space-x-6 sm:mt-0">
                        <a href="https://www.tokopedia.com/ijb-teknik-solution" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-white dark:hover:text-white">
                            <svg class="h-10 w-10" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                        ...
                        <a href="https://www.instagram.com/indonusajayabersama" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-white dark:hover:text-white">
    ...
    <div class="m-5 sm:flex sm:items-center sm:justify-center">
        <span class="text-sm text-gray-500 dark:text-gray-400 sm:text-center">© 2025 <a href="#" class="hover:underline">
