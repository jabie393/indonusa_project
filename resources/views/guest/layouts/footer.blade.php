            ...
            <div class="md:flex md:justify-between">
                    ...
                    <div>
                        <a href="/" class="flex items-center">
                            <span class="self-center whitespace-nowrap text-2xl font-semibold text-white">
                                ...
                                <br />
                                <span>
                                    <p class="text-whote text-sm font-normal lg:text-base">
                ...
                <div class="grid grid-rows-2 sm:grid-rows-3 sm:gap-1">
                    ...
                    <div class="mt-4 flex justify-end space-x-6 sm:mt-0">
                        <a href="https://www.tokopedia.com/ijb-teknik-solution" class="text-gray-500 hover:text-white dark:hover:text-white">
                        ...
                        <a href="https://www.instagram.com/indonusajayabersama" class="text-gray-500 hover:text-white dark:hover:text-white">
